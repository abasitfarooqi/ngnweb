...
class MitSuccessInternalNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('✅ MIT Payment SUCCESS - ' . $customerName)
            ->greeting('MIT Payment Processed Successfully')
            ->line('A recurring payment has been processed successfully.')
            ...
            ->line('**Processed:** ' . $clearedAt->format('d/m/Y H:i:s'))
