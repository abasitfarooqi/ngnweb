...
class Kernel extends ConsoleKernel
{
    protected $commands = [
        ...
        \App\Console\Commands\SendLogbookTransferredYearsReport::class,
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        // Send Weekly Least Busiest Days Report - Sundays at 18:00 (evening, past 7 days, least busy first)
        $schedule->command('app:send-weekly-least-busiest-days-report')
            ->weeklyOn(0, '18:00')
            ->description('Sends out the weekly least busiest days report on Sundays at 6 PM.');
