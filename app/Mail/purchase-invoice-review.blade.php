...
<body>
    <div class="container">
        <div class="header text-center mb-4">
            <div class="logo">
                <img src="https://neguinhomotors.co.uk/img/ngn-motor-logo-fit-small-ngn.png" alt="Neguinho Motors Logo">
            </div>
    ...
    <div class="container">
        <form action="/signed/sell-invoice/create-new-invoice" method="POST">
            @csrf
            <div class="row">
                <div class="col-md-5">
                ...
                <div class="text-center">
                    ...
                    <div id="signature-pad-booking-id">
                        <input type="hidden" name="sell_id" value="{{ $purchase_id }}">
                    </div>
                    <div style="text-align: center;" id="sigpad">
                        <x-creagia-signature-pad class="kbw-signature" style="color: white;width:100%; height:400px"
                            ...
                            button-classes="bg-gray-100 px-4 py-2 rounded-xl mt-4" clear-name="Clear"
                            submit-name="Submit" />
                    </div>
                </div>
        </form>
