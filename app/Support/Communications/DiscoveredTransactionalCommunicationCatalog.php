...
class DiscoveredTransactionalCommunicationCatalog implements TransactionalCommunicationDefinitionProvider
{
    ...
    public function definitions(): array
    {
        return [
            ...
            $this->mail('rental.referral.invitation', 'Rental Referral Invitation', 'Invitation sent to a person referred for motorcycle rental.', 'rentals', \App\Mail\RentingReferralInvitationMail::class, 'emails.templates.agreement-controller-universal', 'Submitted email on the rental referral', ['referral', 'referrer', 'share_url']),
            $this->mail('rental.referral.under_review', 'Rental Referral Under Review', 'Notice to the referrer when a referred rental has qualified and is under review.', 'rentals', \App\Mail\RentingReferralUnderReviewMail::class, 'emails.templates.agreement-controller-universal', 'Referrer customer email', ['referral', 'referrer']),
            $this->mail('rental.referral.reward_available', 'Rental Referral Reward Available', 'Notice to the referrer when reward points can be used.', 'rentals', \App\Mail\RentingReferralRewardAvailableMail::class, 'emails.templates.agreement-controller-universal', 'Referrer customer email', ['referral', 'points']),
            $this->mail('rental.referral.approval_report', 'Rental Referral Approval Report', 'Internal approval report sent after a rental referral reward is approved.', 'rentals', \App\Mail\RentingReferralApprovalReportMail::class, 'emails.templates.agreement-controller-universal', 'Configured internal recipient', ['referral', 'approver', 'checks', 'logs']),
        ];
    }
