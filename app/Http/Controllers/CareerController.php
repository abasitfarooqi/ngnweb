...
class CareerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('livewire.agreements.migrated.frontend.ngnstore.careers', compact('careers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('livewire.agreements.migrated.frontend.ngnstore.career-details', compact('career'));
    }
}
