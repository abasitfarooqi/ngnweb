...
class SalesController extends Controller
{
    ...
    public function NewBikeDetails(Request $request, $id)
    {
        ...
        return view('frontend.motorcycle-new', compact('motorcycle'));
    }
    ...
    public function UsedForSale()
    {
        ...
        return view('frontend.motorcycles-used', compact('motorbikes', 'LatestMotorcycles'));
    }
    ...
    public function UsedBikeDetails($id)
    {
        ...
        return view('frontend.motorcycle-used', compact('motorcycle', 'branchName'));
    }
