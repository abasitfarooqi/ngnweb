...
class NgnOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.ngnstore.user_panel.orders.index', compact('orders'));
    }
    ...
    public function show($id)
    {
        ...
        return view('frontend.ngnstore.user_panel.orders.details', compact('order'));
    }
    ...
    public function tracking($id)
    {
        ...
        return view('frontend.ngnstore.user_panel.orders.tracking', compact('order'));
    }
    ...
    public function confirm($id)
    {
        ...
        return view('frontend.ngnstore.user_panel.orders.confirm', compact('order'));
    }
