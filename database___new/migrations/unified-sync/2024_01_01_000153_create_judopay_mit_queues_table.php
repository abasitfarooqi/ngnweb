...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('DROP TABLE IF EXISTS '.$this->qid('judopay_mit_queues'));
        DB::unprepared(<<<'SQL'
CREATE TABLE `judopay_mit_queues` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `ngn_mit_queue_id` bigint(20) unsigned NOT NULL,
  `judopay_payment_reference` varchar(255) DEFAULT NULL COMMENT 'yourPaymentReference for this MIT run. The procedure will generate the payment reference. and same will write here and prepare for the payload.',
  ...
  `retry` int(11) NOT NULL DEFAULT 0 COMMENT 'ONLY IF API NOT RESPONSE. HTTP ERROR OR TIMEOUT WHICH WILL RETRY IN NEXT 30 Seconds. The Fire means if JudoPay API response http is respoinse.',
