...
CREATE TABLE `new_motorbikes` (
  ...
  `VRM` varchar(255) NOT NULL DEFAULT 'N/A',
  `make` varchar(255) NOT NULL DEFAULT 'N/A',
  `model` varchar(255) NOT NULL DEFAULT 'N/A',
  `colour` varchar(255) NOT NULL DEFAULT 'N/A',
  `engine` varchar(255) NOT NULL DEFAULT 'N/A',
  `year` varchar(255) NOT NULL DEFAULT 'N/A',
  `VIM` varchar(255) NOT NULL DEFAULT 'N/A',
  `branch_id` bigint(20) unsigned NOT NULL,
  `user_id` bigint(20) unsigned NOT NULL,
  `status` varchar(255) NOT NULL DEFAULT 'N/A',
