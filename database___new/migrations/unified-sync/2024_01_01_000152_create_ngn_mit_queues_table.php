...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('DROP TABLE IF EXISTS '.$this->qid('ngn_mit_queues'));
        DB::unprepared(<<<'SQL'
CREATE TABLE `ngn_mit_queues` (
  ...
  `mit_attempt` enum('not attempt','first','second','manual') NOT NULL DEFAULT 'not attempt' COMMENT 'not attempt: not attempt to fire MIT. first: first attempt to fire MIT. second: second attempt to fire MIT. manual: manual collection.',
