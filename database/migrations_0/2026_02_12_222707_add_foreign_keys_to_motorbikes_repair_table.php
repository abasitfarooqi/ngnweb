...
return new class extends Migration
{
    ...
    {
        Schema::table('motorbikes_repair', function (Blueprint $table) {
            $table->dropForeign('motorbikes_repair_branch_id_foreign');
            $table->dropForeign('motorbikes_repair_motorbike_id_foreign');
            $table->dropForeign('motorbikes_repair_user_id_foreign');
        });
    }
};
