...
CREATE TABLE `motorbikes` (
  ...
  `vin_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `co2_emissions` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `motorbikes_branch_id_foreign` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`),
  CONSTRAINT `motorbikes_vehicle_profile_id_foreign` FOREIGN KEY (`vehicle_profile_id`) REFERENCES `vehicle_profiles` (`id`)
