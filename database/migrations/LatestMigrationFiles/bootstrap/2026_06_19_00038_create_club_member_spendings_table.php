...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('club_member_spendings')) {
            return;
        }
...
CREATE TABLE `club_member_spendings` (
  ...
  CONSTRAINT `club_member_spendings_club_member_id_foreign` FOREIGN KEY (`club_member_id`) REFERENCES `club_members` (`id`),
  CONSTRAINT `club_member_spendings_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
