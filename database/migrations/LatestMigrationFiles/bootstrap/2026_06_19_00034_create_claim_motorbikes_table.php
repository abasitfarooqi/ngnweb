...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('claim_motorbikes')) {
            return;
        }
...
CREATE TABLE `claim_motorbikes` (
  ...
  CONSTRAINT `claim_motorbikes_branch_id_foreign` FOREIGN KEY (`branch_id`) REFERENCES `branches` (`id`),
  CONSTRAINT `claim_motorbikes_motorbike_id_foreign` FOREIGN KEY (`motorbike_id`) REFERENCES `motorbikes` (`id`),
  CONSTRAINT `claim_motorbikes_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
