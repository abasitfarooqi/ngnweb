...
CREATE TABLE `products` (
  ...
  `type` enum('deliverable','downloadable') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `weight_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'kg',
  `height_value` decimal(10,5) unsigned DEFAULT '0.00000',
  `height_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cm',
  `width_value` decimal(10,5) unsigned DEFAULT '0.00000',
  `width_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cm',
  `depth_value` decimal(10,5) unsigned DEFAULT '0.00000',
  `depth_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cm',
  `volume_value` decimal(10,5) unsigned DEFAULT '0.00000',
  `volume_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'l',
