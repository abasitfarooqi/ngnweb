...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('judopay_mit_queues')) {
            return;
        }
...
CREATE TABLE `judopay_mit_queues` (
  ...
  `judopay_payment_reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'yourPaymentReference for this MIT run. The procedure will generate the payment reference. and same will write here and prepare for the payload.',
  ...
  CONSTRAINT `judopay_mit_queues_authorized_by_foreign` FOREIGN KEY (`authorized_by`) REFERENCES `users` (`id`),
  CONSTRAINT `judopay_mit_queues_ngn_mit_queue_id_foreign` FOREIGN KEY (`ngn_mit_queue_id`) REFERENCES `ngn_mit_queues` (`id`)
