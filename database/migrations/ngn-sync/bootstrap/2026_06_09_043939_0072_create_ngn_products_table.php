...
`colour` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
`pos_variant_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
`pos_product_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
`sorting_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '0',
