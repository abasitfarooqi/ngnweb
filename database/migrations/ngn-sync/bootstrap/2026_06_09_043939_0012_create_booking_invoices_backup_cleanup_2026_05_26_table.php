...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('DROP TABLE IF EXISTS '.$this->qid('booking_invoices_backup_cleanup_2026_05_26'));
        DB::unprepared(<<<'SQL'
CREATE TABLE `booking_invoices_backup_cleanup_2026_05_26` (
...
SQL
    ...
    {
        Schema::dropIfExists('booking_invoices_backup_cleanup_2026_05_26');
    }
