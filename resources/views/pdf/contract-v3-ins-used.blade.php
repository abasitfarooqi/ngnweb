...
<body>
    ...
    <table class="table-con">
        ...
        <tr>
            ...
            <td class="td-cont">
                {{ \Carbon\Carbon::parse($booking->contract_date)->addYears(5)->format('d-F-Y H:i') }}
            </td>
    ...
    <div class="container">
        ...
        <div class="container" style="padding:0px !important; margin:0px !important;">
            ...
            <p style="padding-top:8px !important">
                Customers are liable to pay 50% of total cost upfront for any electrical repairs.

                Customers are liable to pay 50% of total cost upfront for any engine repairs.

                The limited warranty is only valid whilst the total amount of the vehicle is outstanding, this warranty
                will automatically expire once the vehicle has been fully paid and no outstanding amount is held against
                the vehicle.
            </p>
            <p style="padding-bottom:4px !important">Used vehicles described in this contract must have its engine oil
                changed every week at Neguinho Motors Ltd shop to claim the
                engine warranty repairs. All receipts must be kept as proof. Failing to provide one or all receipts will
                automatically void the
                engine warranty repairs.</p>
