            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">EXPIRY DATE:
                        {{ \Carbon\Carbon::parse($booking->contract_date)->addMonths(18)->format('d-F-Y H:i') }}</li>
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            @php
                ...
                $contractExpiry = Carbon::parse($booking->created_at)->addMonths(18);
        ...
        <ul style="padding-left:9px;margin-left:9px">
            ...
            <li>•&emsp;The user <strong>NEGUINHO MOTORS LTD or HI-BIKE4U LTD </strong> is the legal owner
                of
        ...
        <div class="modal fade" id="signatureModal" tabindex="-1" aria-labelledby="signatureModalLabel"
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content text-center">
                    <form action="/signed/bookings/create-new-contract-ins-18m-extended-custom" method="POST">
                        @csrf
                        <div class="text-center">
