    ...
    <form wire:submit.prevent="save" class="space-y-5" novalidate>
        <div class="border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900 p-5">
            ...
            <div class="flux-admin-form-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <x-flux-admin::field-group label="Paid amount (£)" :error="$errors->first('form.paid_amount')">
                    <flux:input type="number" step="0.01" wire:model="form.paid_amount" />
                </x-flux-admin::field-group>
            ...
            <div class="mt-4">
                <label class="flex items-center gap-2 text-sm text-zinc-700 dark:text-zinc-300">
                    <input type="checkbox" wire:model="form.is_paid" class="accent-zinc-900 dark:accent-zinc-200"> Settled / paid
                </label>
            </div>
        </div>
