<div class="w-full max-w-md mx-auto px-4">
    <div class="text-center mb-8">
        <a href="/" class="inline-block">
            <img class="h-12 w-auto mx-auto" src="{{ asset('img/ngn-motor-logo-fit-small-ngn.png') }}" alt="NGN Motors">
        </a>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm px-6 py-8 sm:px-8">
        ...
        <form wire:submit="sendResetLink" class="site-form site-form-stack">
            <div>
