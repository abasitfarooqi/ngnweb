...
<body>
    ...
    <table class="table-con">
        ...
        <tr>
            ...
            <td class="td-cont">{{ \Carbon\Carbon::parse($booking->contract_date)->addMonths(5)->format('d-F-Y H:i') }}
            </td>
            <td class="td-cont">{{ $booking->motorbike_price }}</td>
            <td class="td-cont">{{ $booking->deposit }}</td>
            <td class="td-cont">600.00</td>
    ...
    <div class="container">
        ...
        <div class="container" style="padding:0px !important; margin:0px !important;">
            ...
            @php
                ...
                $contractExpiry = Carbon::parse($booking->contract_date)->addMonths(5);
        ...
        <div style="padding: 0px !important; margin:0px !important; text-align: justify;">
            <div class="container"><b>Important Notice 1</b>
                <p>No modifications should be made to the vehicle without
