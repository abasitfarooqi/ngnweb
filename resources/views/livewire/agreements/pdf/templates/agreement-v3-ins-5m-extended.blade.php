{{-- Agreement Rent | 12 MAR 2025 V3 Update Rev.3 --}}
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0px;
            font-size: 11px;
            background: url('{{ secure_asset('https://ngnmotors.co.uk/img/watermark.png') }}');
...
<body>
    ...
    <div class="watermark" style="letter-spacing: 1.7px">{{ $motorbike->reg_no }}
        {{ $customer->first_name }}
        {{ $motorbike->reg_no }} {{ $customer->first_name }} | V2 Rev#2</div>


    <span style="font-size:7px">V3 Rev#0 - {{ $document_number }}</span>
    <div class="header" style="padding:1px;margin:1px">

        <table style="border:none !important;padding:1px;margin:1px">
            <tr>
                <td style="width: 20%">
                    <img src="{{ secure_asset('https://ngnmotors.co.uk/img/ngn-motor-logo-fit-small.png') }}"
                ...
                <td style="width: 25%">
                    <div class="title">VEHICLE HIRE CONTRACT</div>
                </td>
            </tr>
        </table>
    </div>
        ...
        <tr class="no-border">
            <td class="td-cont" colspan="2"
                style="font-size:10px ; padding-bottom: 15px; padding-top:10px; margin-top:10px"><b>ALL DOCUMENTS AND
                    PAYMENTS MUST BE DONE WITHIN48 HOURS OF CONTRACT, FAILIING TO DO SO WILL
    ...
    <table class="table-con">
        ...
        <tr class="no-border">
            <td class="td-cont" colspan="2" class="left-padding">FOR CONTRACTS OR PAYMENT CALL: 0203 409 5478 or 0208
                314
                1498</td>
        </tr>
        <tr class="no-border">
    ...
    <table class="table-con">
        ...
        <tr>
            ...
            <!-- <td class="td-cont">{{ \Carbon\Carbon::parse($booking->start_date)->addMonths(5)->format('d-F-Y') }}</td> -->
            <td class="td-cont">{{ \Carbon\Carbon::createFromFormat('d/m/Y H:i', $agreementStartDate)->format('d-F-Y H:i') }}</td>
            <td class="td-cont">{{ \Carbon\Carbon::createFromFormat('d/m/Y H:i', $agreementEndDate)->format('d-F-Y H:i') }}</td>
    ...
    <div class="container">
        ...
        <div class="container" style="padding:0px !important; margin:0px !important;">
            ...
            @php
                ...
                // Parse the creation date of the booking and add 5 months to set the fixed expiry of the hire agreement
                $contractExpiry = Carbon::createFromFormat('d/m/Y H:i', $agreementStartDate)->addMonths(5);
        ...
        <ul style="margin-top:0px !important;padding-top:0px !important; padding-left:10px !important">
            ...
            <li>The user <b>{{ $customer->first_name }} {{ $customer->last_name }}</b> is the legal owner of
                the vehicle.</li>
