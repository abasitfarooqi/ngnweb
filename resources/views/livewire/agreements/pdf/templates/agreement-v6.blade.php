...
<body>
    ...
    <div class="container">
        ...
        <p>This contract is valid till date <b>{{ $contractExpiry->format('d-F-Y') }}</b> from the 'contract date' under the 'contract information' section shown at the first page of this document.</p>
