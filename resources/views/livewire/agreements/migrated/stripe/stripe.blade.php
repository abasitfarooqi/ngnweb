...
<body>
                ...
                <div class="container-fluid container-width-93 clearfix" id="site-header-inner">
                    <div id="logo" class="logo float-left image-responsive col-sm-3 col-md-4">
                        <a href="/" title="logo" class="logo">
                            <img src="{{ url('img/ngn-motor-logo-fit-small-ngn.png') }}" alt="Neguinho Motors"
                                width="70%" height="24"
                                data-retina="{{ url('img/ngn-motor-logo-fit-small-ngn.png') }}" data-width="70%"
                                data-height="24">
                        </a>
                    </div><!-- /.logo -->
                    ...
                    <ul class="menu-extra">
                        <!-- <li class="box-search">
                            ...
                            <form role="search" method="get" class="header-search-form"
                                ...
                                <input type="text" value="{{ request('query') }}" name="query" class="header-search-field" placeholder="Search...">
                                <button type="submit" class="header-search-submit" title="Search">Search</button>
                            </form>
                        </li>
                        <li class="box-cart nav-top-cart-wrapper">
                            <a class="icon_cart nav-cart-trigger " href="/cart"><span>
                                    {{ Cart::instance('default')->count() }}</span></a>
                        </li> -->
                    </ul>
                </div><!-- /.container-fluid -->
            </header>
    ...
    <!-- Javascript -->
    @include('livewire.agreements.migrated.frontend.body.footer-scripts')
</body>
