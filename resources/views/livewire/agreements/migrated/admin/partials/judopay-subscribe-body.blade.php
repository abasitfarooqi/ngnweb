                ...
                <div class="col-md-7">
                    <x-ui.panel title="Initiate Customer Transaction (CIT)" icon="fa fa-credit-card">
                        ...
                        <div style="position: relative; {{ $isCompleted ? 'opacity: 0.6; pointer-events: none;' : '' }}">
                            ...
                            @endif
                            <form method="POST" action="{{ judopay_route('generate-authorization-access') }}">
                                @csrf
                                ...
                                <div class="row m-3">
                                    <div class="col-12">
                                        ...
                                        <a href="{{ judopay_route('index') }}" class="btn btn-secondary btn-sm ml-2"
                            ...
                            @if ($activeSession ?? false)
                                <div class="mt-3 border-top pt-3">
                                    ...
                                    <form method="POST" action="{{ judopay_route('kill-previous-links') }}"
                            ...
                            @if (session('link_generated'))
                                <x-ui.alert type="success" title="Authorisation Link Generated Successfully!">
                                    ...
                                    <!-- Send Email Button -->
                                    <form method="POST" action="{{ judopay_route('send-authorization-email') }}"
                                        style="display: inline-block;">
                                        @csrf
                                        <input type="hidden" name="customer_id" value="{{ $customer->id }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <p class="mb-1" style="font-size: 0.75rem; color: #ecf0f1;">
                                                ...
                                                @if ($subscription->subscribable_type === 'App\Models\FinanceApplication')
                                                    <form method="POST" action="{{ judopay_route('update-billing-day') }}" style="display: inline-block;" id="billing-form-{{ $subscription->id }}">
                                                        @csrf
                                                        <input type="hidden" name="subscription_id" value="{{ $subscription->id }}">
                                        ...
                                        <div class="col-md-3">
                                            <p class="mb-1" style="font-size: 0.75rem; color: #ecf0f1;">
                                                ...
                                                @if ($subscription->subscribable_type === 'App\Models\FinanceApplication')
                                                    <form method="POST" action="{{ judopay_route('update-amount') }}" style="display: inline-block;" id="amount-form-{{ $subscription->id }}">
                                                        @csrf
                                                        <input type="hidden" name="subscription_id" value="{{ $subscription->id }}">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="border rounded p-3"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form method="POST" action="{{ judopay_route('close-subscription') }}"
                                                ...
                                                <td style="border: none; padding: 12px 8px;">
                                                    ...
                                                    @elseif($session->status === 'success')
                                                        ...
                                                        @can('judopay-can-refund')
                                                                <form method="POST" action="{{ judopay_route('cit-refund', $session->id) }}" class="refund-form" style="display: inline-block;" data-session-id="{{ $session->id }}">
                                                                    @csrf
