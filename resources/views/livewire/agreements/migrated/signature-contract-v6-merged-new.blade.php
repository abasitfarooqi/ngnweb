...
<body class="agreement-signing-page">
    ...
    <div class="container">
                @include('livewire.agreements.partials.signing-contract-header', ['title' => 'MOTORCYCLE SALE AGREEMENT & 12-MONTH SUBSCRIPTION CONTRACT'])
...
<p>The following charges apply in addition to the main Agreement. All fees reflect the genuine costs incurred by the Seller/Hirer and are enforceable under UK law.</p>
    ...
    <div class="container" style="margin-top: 0px;">
        ...
        <p>
            ...
            <strong>Term:</strong> 12 months, at expiry you may: (a) return the motorcycle, <br>(b) exchange for a new subscription under a new Agreement,<br>(c) enter a separate purchase agreement or pay a documented buy-out fee (no automatic transfer of ownership).<br>
        ...
        <br>
        <p>
            6.1. At the end of the 12 months the Customer may:<br> (a) Return the motorcycle to Neguinho Motors Ltd / HI-BIKE4U LTD in accordance with the Return Condition Report (Annex); or<br> (b) Exchange the motorcycle for a new subscription under a new Agreement; or<br> (c) Purchase the motorcycle by entering a separate written purchase agreement (see clause 6.3). No ownership transfers automatically at the end of the subscription.<br>
        ...
        <p>
            ...
            7.3. Repair decision; cancellation and replacement subscription.<br> (a) Where, following an accident, the cost of repair exceeds commercially sensible limits and the Customer elects not to authorise repair, the Customer may cancel the current subscription in accordance with clause 8 (Early termination). Cancellation in those circumstances does not extinguish the Customer's liability for any unpaid Monthly Fees, damage charges, unpaid PCNs, administration costs, or any sums properly payable to Neguinho Motors Ltd / HI-BIKE4U LTD in respect of the incident.<br> (b) On cancellation the Customer may, subject to Neguinho Motors Ltd / HI-BIKE4U LTD's written approval and any applicable affordability checks, enter into a new subscription agreement for a replacement Vehicle. Neguinho Motors Ltd / HI-BIKE4U LTD is under no obligation to offer identical terms for any replacement subscription.<br>
            7.4. Entitlement to goodwill settlement (not-at-fault) — six month rule.<br> (a) If the Customer is legally determined to be not at fault for the incident and, following conclusion of all insurer and third-party processes (including any subrogation), Neguinho Motors Ltd / HI-BIKE4U LTD receives cleared funds from insurers or third parties attributable to the loss or damage to the Vehicle (the "Recovery"), Neguinho Motors Ltd / HI-BIKE4U LTD will pay the Customer a goodwill payment equal to 50% of Neguinho Motors Ltd / HI-BIKE4U LTD's Recovery, provided that:<br> (i) at least six (6) months have elapsed from the Contract Start Date; and<br> (ii) the insurance claim is final and all Recovery funds have been received by Neguinho Motors Ltd / HI-BIKE4U LTD; and<br> (iii) Neguinho Motors Ltd / HI-BIKE4U LTD's insurers have not exercised subrogation rights which reduce Neguinho Motors Ltd / HI-BIKE4U LTD's recovery.<br> (b) For the purpose of this clause "Neguinho Motors Ltd / HI-BIKE4U LTD's Net Recovery" means the amount actually received by Neguinho Motors Ltd / HI-BIKE4U LTD from insurers or third parties in respect of the Vehicle after deduction of (i) Neguinho Motors Ltd / HI-BIKE4U LTD's reasonable repair or replacement costs properly incurred (each evidenced by invoices), (ii) Neguinho Motors Ltd / HI-BIKE4U LTD's reasonable administration costs (capped at £200), and (iii) any sums payable to Neguinho Motors Ltd / HI-BIKE4U LTD's insurers by way of subrogation.<br> (c) No goodwill payment will be made while the claim remains open or provisional or until Neguinho Motors Ltd / HI-BIKE4U LTD has received cleared funds. Payment, if any, will be made within twenty-eight (28) days of receipt by Neguinho Motors Ltd / HI-BIKE4U LTD of cleared funds and the expiry of any reasonable dispute or challenge period.<br>
        ...
        <br>
        <p>
            9.1. The Customer shall indemnify and hold harmless Neguinho Motors Ltd / HI-BIKE4U LTD, its officers, employees and agents against all liabilities, losses, damages, costs and expenses (including legal and enforcement costs on a full indemnity basis) which Neguinho Motors Ltd / HI-BIKE4U LTD may suffer or incur as a result of:<br> (a) any breach by the Customer of this Agreement;<br> (b) any fines, penalties, PCNs or other monetary sanctions arising from the Customer's use of the Vehicle;<br> (c) damage to the Vehicle caused while the Vehicle is in the Customer's possession (except to the extent caused by Neguinho Motors Ltd / HI-BIKE4U LTD's negligence);<br> (d) any claim by a third party arising from the Customer's negligence, wilful misconduct or breach of law. Neguinho Motors Ltd / HI-BIKE4U LTD shall use reasonable endeavours to mitigate any loss for which it seeks indemnity under this clause.<br>
            ...
            9.3. Nothing in this Agreement shall exclude or restrict;<br> (a) liability for death or personal injury resulting from Neguinho Motors Ltd / HI-BIKE4U LTD's negligence;<br> (b) liability for fraud or fraudulent misrepresentation; or<br> (c) any liability which cannot be limited or excluded by law.<br>
        ...
        <div class="modal fade agreement-signature-modal-root" id="signatureModal" tabindex="-1" aria-labelledby="signatureModalLabel"
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content text-center">
                    ...
                    <form action="{{ route('admin.finance.createMergedContracts') }}" method="POST" data-signing-pdf-count="5">
                        @csrf
