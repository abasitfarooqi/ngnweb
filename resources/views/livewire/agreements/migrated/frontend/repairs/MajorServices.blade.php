...
<title>@yield('title', 'Major Services - NGN Motorcycle Repairs - Motorcycle Rentals, Sale in UK')</title>
...
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="pagehero-title-heading xt">
                        <h1 class="title">Major Motorcycle Service</h1>
                    </div>
                    <div class="breadcrumbs">
                        <ul>
                            <li><a href="/">Home Page</a></li>
                            <li><a href="/motorbike-service-comparison">Compare Services</a></li>
                            <li><a href="/major-services">Major Motorcycle Service</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="container mt-5">
        <!-- <h1 class="text-center ngn-title mb-4 active-color">Major Motorcycle Service</h1> -->
        ...
        <div class="row ">
            <div class="col-12">
                <div class="alert alert-info">
                    ...
                    Our Major Service package provides comprehensive maintenance and inspection of all critical motorcycle
                ...
                <div class="card repair-card h-100">
                    <div class="card-body">
                        <h3 class="active-color card-title">
                            ...
                            <!-- <i class="fas fa-engine me-2 text-primary"></i> -->
                ...
                <div class="card repair-card h-100">
                    <div class="card-body">
                        <h3 class="active-color card-title">
                            ...
                            <!-- <i class="fas fa-car-suspension me-2 text-primary"></i> -->
            ...
            <div class="col-md-12 mb-3">
                <div class="wrap-contact">
                    <div id="enquireForm" style="display: none;">
                        <h3>Book Your Major Service Today</h3>
                        
                        <form action="{{ route('handle-booking') }}" method="POST">
                            @csrf

                            <input type="hidden" name="service_type" value="Motorcycle Full Service">
            ...
            <div class="col-12 ">
                <div class="card repair-card bg-dark text-white">
                    <div class="card-body text-center">
                        <h3 class="active-color mb-4">Book Your Major Service Today</h3>
                        <p class="mb-4">Keep your motorcycle performing at its best with our comprehensive major service
                            package</p>
