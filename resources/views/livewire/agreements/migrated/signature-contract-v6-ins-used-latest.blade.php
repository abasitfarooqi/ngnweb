...
<div class="container">
        ...
        <!-- <h4 style="text-align: center; font-weight: bold; margin: 30px 0;text-transform:uppercase;"><b>ACCEPTANCE OF OFFENCES, PENALTIES & LIABILITY TRANSFER FORM</b></h4> -->
        ...
        <p>
            ...
            <ul>
                ...
                <li>Road Traffic Regulation Act 1984, including statutory provisions relating to moving, stopping, parking, and restricted zones;</li>
                <li>Road Traffic Offenders Act 1988, including statutory provisions relating to fixed penalties and keeper liability;</li>
        ...
        <p>
            ...
            <ul>
                <li>a) Any Penalty Charge Notice, Excess Charge Notice, Fixed Penalty Notice, Bus Lane Penalty, CCTV enforcement penalty, Congestion Charge, ULEZ charge, toll, or any statutory charge incurred in relation to the use or keeping of the vehicle;</li>
                <li>b) Any contravention under the Traffic Management Act 2004, Road Traffic Regulation Act 1984, London Local Authorities Acts, or Transport for London legislation;</li>
                <li>c) Any road traffic offence committed under the Road Traffic Act 1988 or Road Traffic Offenders Act 1988;</li>
        ...
        <div class="modal fade agreement-signature-modal-root" id="signatureModal" tabindex="-1" aria-labelledby="signatureModalLabel"
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content text-center">
                    ...
                    <form action="{{ route('admin.finance.createNewAgreement.ins.used.latest') }}" method="POST">
                        @csrf
