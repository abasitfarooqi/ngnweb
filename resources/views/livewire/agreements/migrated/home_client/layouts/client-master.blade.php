        ...
        <div class="container">
            <div class="w-100 d-flex justify-content-between">
                ...
                @auth
                    ...
                    <div>
                        <a style="color: white;" class="text-light" style="padding-right: 5px;"
                            href="{{ route('logout.perform') }}" onmouseover="this.style.color='#f63440'"
                            onMouseOut="this.style.color='#fff'">Logout</a>
                    </div>
                @endauth
                ...
                @guest
                    <div>
                        <a style="color: white;" class="text-light" style="padding-right: 5px;"
                            href="{{ route('login.perform') }}" onmouseover="this.style.color='#f63440'"
                            onMouseOut="this.style.color='#fff'">Login </a> /
                        <a style="color: white;" class="text-light" style="padding-right: 5px;"
                            href="{{ route('register.perform') }}" onmouseover="this.style.color='#f63440'"
        ...
        <div id="logo" class="logo float-left image-responsive col-sm-3 col-md-4">
            <a href="/" title="logo" class="logo">
                <img src="{{ url('img/ngn-motor-logo-fit-optimized.png') }}" alt="Neguinho Motors" width="70%"
                    height="24" data-retina="{{ url('img/ngn-motor-logo-fit-optimized.png') }}" data-width="70%"
                    data-height="24">
            </a>
        </div><!-- /.logo -->
