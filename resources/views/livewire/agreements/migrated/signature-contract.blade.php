...
<body class="agreement-signing-page">
    <div class="container-fluid">
        <p class="agreement-expiry-banner text-center"
            ...
            LINK WILL
            EXPIRE BY: {{ $access->expires_at->format('d F Y') }}.</p>
    </div>
    <div class="container">
            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">CONTRACT DATE:
                        {{ \Carbon\Carbon::parse($booking->contract_date)->format('d-F-Y') }}</li>
                    {{-- <li class="list-group-item">FIRST INSTALMENT DATE:
                        {{ \Carbon\Carbon::parse($booking->first_instalment_date)->format('d-F-Y') }}</li> --}}
                    <li class="list-group-item">VEHICLE PRICE: {{ $booking->motorbike_price }}</li>
                    <li class="list-group-item">PAID: {{ $booking->deposit }}</li>
                    <li class="list-group-item">WEEKLY: {{ $booking->weekly_instalment }}</li>
        ...
        <div class="table-responsive d-none d-md-block">
            <table class="table-con">
                ...
                <tr>
                    ...
                    {{-- <td class="td-cont">FIRST INSTALMENT DATE</td> --}}
                ...
                <tr>
                    ...
                    <td class="td-cont">{{ \Carbon\Carbon::parse($booking->contract_date)->format('d-F-Y') }}

                    </td>
                    {{-- <td class="td-cont">{{ \Carbon\Carbon::parse($booking->first_instalment_date)->format('d-F-Y') }}
                    </td> --}}
    ...
    <div class="container">
        ...
        <div class="agreement-section">
            <h2 style="text-align: center;">DEFINITIONS AND GENERAL PRINCIPLES</h2>
        ...
        <ul>
            ...
            <li>•&emsp;We may contact you if any changes to the terms and conditions of this contract are made. Any
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="text-center"><strong>Date:
                            {{ \Carbon\Carbon::createFromFormat('d/m/Y', $today)->format('d-F-Y') }} </strong>
                    </p>
                </div>
            </div>
        </div>
        ...
        <ul style="padding: 12px; margin:12px; text-align: justify;">
            <li><b>I <b>{{ $customer->first_name }} {{ $customer->last_name }}</b> hereby declare the following:</b>
            </li>
            ...
            <li>•&emsp;I <b>{{ $customer->first_name }} {{ $customer->last_name }}</b> must immediately notify the
                seller
            ...
            <li>•&emsp;I <b>{{ $customer->first_name }} {{ $customer->last_name }}</b> am responsible to pay all
                fines,
    ...
    <div style="padding: 12px; margin:12px; text-align: justify;">
        <div class="container"><b>Important Notice 1</b>
            <p>No modifications should be made on the vehicle without agreed in
                writing
                by
                the owner <b>Thiago Fauster Martins</b> as it may void any warranty. NEW VEHICLES MUST HAVE THEIR FIRST
                SERVICE AT
                600
                MILES, failing to service the vehicle on its first 600 miles will void the warranty and the buyer will
                be
                liable
                for
