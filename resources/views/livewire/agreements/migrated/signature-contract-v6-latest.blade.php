...
<p>The following charges apply in addition to the main Agreement. All fees reflect the genuine costs incurred by the Seller/Hirer and are enforceable under UK law.</p>
    ...
    <div class="">
        ...
        <div class="modal fade agreement-signature-modal-root" id="signatureModal" tabindex="-1" aria-labelledby="signatureModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content text-center">
                    <form action="{{ route('admin.finance.createNewAgreement.latest') }}" method="POST">
                        @csrf
