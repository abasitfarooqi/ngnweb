...
<body class="agreement-signing-page">
    ...
    <div class="container">
        <p class="h6 bg-info text-center"
            ...
            Read the below agreement carefully<br>You are require to sign it at the end of page.
        </p>
                @include('livewire.agreements.partials.signing-contract-header', ['title' => 'RENTAL AGREEMENT'])


        <div class="d-md-none">
            <div class="card">
                <div class="card-header">RENTER INFORMATION</div>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">Owner: {{ $customer->first_name }} {{ $customer->last_name }}</li>
        ...
        <div class="d-md-none">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">BOOKING DATE: {{ $booking->created_at }}</li>
                    <li class="list-group-item">DEPOSIT: {{ $booking->deposit }}</li>
                    <li class="list-group-item">RENT: {{ $bookingItem->weekly_rent }}</li>
                    <li class="list-group-item">START DATE:
                        {{ \Carbon\Carbon::parse($booking->start_date)->format('Y-m-d') }}</li>
                    <li class="list-group-item">BOOKED BY: {{ $user_name }}</li>
                </ul>
            </div>
        </div>
