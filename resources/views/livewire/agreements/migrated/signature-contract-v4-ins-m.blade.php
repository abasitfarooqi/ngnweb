...
<body class="agreement-signing-page">
        ...
        <div class="d-md-none">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Monthly(10th of Each Month): £600/-</li>
        ...
        <div class="table-responsive d-none d-md-block">
            <table class="table-con">
                ...
                <tr>
                    ...
                    <td class="td-cont">Monthly(10th of Each Month)</td>
    ...
    <div class="container">
        <form action="/signed/bookings/create-new-contract-ins-m" method="POST">
            @csrf
