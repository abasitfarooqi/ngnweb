<!-- resources/views/frontend/ngnstore/partials/footer-scripts.blade.php -->
<!-- Footer Scripts -->
...
<script src="/assets/js/jquery5.min.js"></script>
...
<!-- <script src="/assets/js/owl5.carousel.min.js"></script> -->
...
<script src="/assets/js/initAOSnTYPEWRITER.js"></script>
<script src="/assets/js/main-no-sticky.js"></script>

{{-- <script src="/assets/js/snowstorm-min.js"></script> --}}
<script>
    //    snowStorm.zIndex = 9999; // Set the z-index
    //    snowStorm.flakesMaxActive = 100; // Maximum number of snowflakes
    //    snowStorm.animationInterval = 33; // Speed of the animation
    //    snowStorm.useTwinkleEffect = true; // Enable twinkle effect
...
{{-- <!-- Revolution Slider Scripts -->
    ...
    <!-- Slider Extensions - Remove if not required -->
