<link rel="stylesheet" type="text/css" href="/assets/css/layout-2-header-black-forced-top-white.css">
<style>
    #site-header-inner {
...
<header id="header" class="header clearfix homepagex forced-blacked">
    ...
    <!-- Start Top Nav -->
    <nav class="navbar navbar-expand d-none d-lg-block forced-whited  pt-1 pb-1"
        style="padding:10px 0 !important;background: white;">
        <div class="container container-width-93">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    <i class="fa fa-envelope mx-2" style="color:black;"></i>
                    <a style="color: black;" class="navbar-sm-brand  text-decoration-none"
                        href="mailto:customerservice@neguinhomotors.co.uk" target="_newtab"
                        onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#000'">Customer
                        Service</a>
                    <i class="fa fa-phone mx-2" style="color:black;"></i>
                    <a style="color: black;" class="navbar-sm-brand  text-decoration-none" href="tel:02083141498"
                        onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#000'">Catford/Sutton:
                        0208 314 1498</a>
                    <i class="fa fa-phone mx-2" style="color:black;"></i>
                    <a style="color: black;" class="navbar-sm-brand  text-decoration-none" href="tel:02084129275"
                        onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#000'">Sutton: 0208 412
                        9275</a>
                    <i class="fa fa-phone mx-2" style="color:black;"></i>
                    <a style="color: black;" class="navbar-sm-brand  text-decoration-none" href="tel:02034095478"
                        onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#000'">Tooting: 0203 409
                        5478</a>
                    <i class="fa fa-bell mx-2" style="color:black;"></i>
                    <i class="fa fa-briefcase mx-2" style="color:black;"></i>
                    <a style="color: black;" class="navbar-sm-brand  text-decoration-none" href="{{ url('/career') }}"
                        onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#000'">Career</a>
                </div>
                ...
                <div>
                    {{-- @if (Route::has('login'))
                        ...
                        @auth
                            ...
                            <a class="navbar-sm-brand  text-decoration-none" href="{{ url('/dashboard') }}"
                                style="color:black;">Dashboard</a>
                        @else
                            <a class="navbar-sm-brand  text-decoration-none" href="{{ route('login') }}"
                                style="color:black;">Log in </a>/

                            @if (Route::has('register'))
                                <a class="navbar-sm-brand  text-decoration-none" href="{{ route('register') }}"
        ...
        <div id="logo" class="logo float-left image-responsive col-lg-2 col-md-4 col-sm-4 col-xs-4">
            <a href="/" title="logo" class="logo">
                <img src="{{ url('img/ngn-motor-logo-fit-small.png') }}" alt="NGN" width="55%"
                    height="24" data-retina="{{ url('img/ngn-motor-logo-fit-small.png') }}" data-width="55%"
                    data-height="24">
            </a>
        </div><!-- /.logo -->
