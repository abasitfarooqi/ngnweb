...
<header id="header" class="header clearfix homepagex">
    ...
    <!-- Start Top Nav -->
    <nav class="navbar navbar-expand navbar-dark bg-dark d-none d-lg-block" style="background-color: #rgb(197, 35, 45);">
        <div class="container">
    ...
    <div class="container container-width-93 clearfix homepagex" id="site-header-inner">
