...
@section('title', 'Honda Forza 125 For Rent - Motorcycle Rental London, Tooting, Sutton, Catford, UK')
                                    ...
                                    <div class="product-info clearfix mb-3">
                                        ...
                                        <ul class="fa-ul mb-3">
                                            ...
                                            <li><i class="fa-li fa fa-check-square" style="color: #cd3232;"></i>CBT
                                                Certification</li>
                                            <li><i class="fa-li fa fa-check-square" style="color: #cd3232;"></i>£300 deposit
                                            </li>
                                            <li><i class="fa-li fa fa-check-square" style="color: #cd3232;"></i>6 Weeks
                                                Minimum Rental Period</li>
                                            <li><i class="fa-li fa fa-check-square" style="color: #cd3232;"></i>Under 25
                                                years old require proof of income & National Insurance Number</li>
                                        </ul>
