@extends('livewire.agreements.migrated.frontend.layouts.app')
                ...
                <div class="flat-image-box style-2 absolute-right flat-carousel-box" data-gap="0" data-auto="false" data-column="1" data-column2="1" data-column3="1">
                    <div class="owl-carousel owl-theme">
                        <div class="item">
                            <div class="inner">
                                <div class="thumb">
                                    <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-1-930x930.jpg') }}" alt="Image">
                                    <div class="text-wrap">
            ...
            <div class="col-md-3">
                ...
                <div class="flat-image-box style-1 absolute-center row2 data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-1-455x455.jpg') }}" alt="Image">
                    ...
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-2-455x455.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
            ...
            <div class="col-md-3">
                ...
                <div class="flat-image-box style-1 absolute-center row2 data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-3-455x455.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
                    ...
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-4-455x455.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
            ...
            <div class="col-md-4">
                <div class="flat-image-box style-1 absolute-center data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-1-610x377.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
            ...
            <div class="col-md-4">
                ...
                <div class="flat-image-box style-1 absolute-center data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-2-610x377.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
            ...
            <div class="col-md-4">
                ...
                <div class="flat-image-box style-1 absolute-center data-effect clearfix">
                    <div class="item data-effect-item">
                        <div class="inner">
                            <div class="thumb">
                                <img loading="lazy" src="{{ asset('assets-frontend/images/image-box/imgbox-3-610x377.jpg') }}" alt="Image">
                                <div class="text-wrap text-center">
