                ...
                @switch($status)
                    @case('Confirmed')
                        <div class="status-badge status-confirmed">
                            <strong style="font-size: 24px;">Order Ready for Collection</strong>
                        </div>
                        <p>Your order is now ready for collection at the selected branch. Please visit the branch to collect
                            your order.</p>
                    @break
                    ...
                    @case('Ready to collect')
                        <div class="status-badge status-ready-to-collect">
                            <strong style="font-size: 24px;">Order Ready for Collection</strong>
                        </div>
                        <p>Your order is now ready for collection at the selected branch. Please visit the branch to collect
                            your order.</p>
        ...
        <div class="shipping-info">
            ...
            @if ($isPickup && $branch)
                ...
                <p><strong>Status: </strong>
                    @switch($branch->name)
                        @case('CATFORD')
                        <p>Your order is ready for collection at our Catford branch. Please visit us to collect your order.</p>
                        <a href="tel:02083141498">0208 314 1498</a>
                    @break

                    @case('TOOTING')
                        <p>Your order is ready for collection at our Tooting branch. Please visit us to collect your order.</p>
                        <a href="tel:02034095478">0203 409 5478</a>
                    @break

                    @case('SUTTON')
                        <p>Your order is ready for collection at our Sutton branch. Please visit us to collect your order.</p>
                        <a href="tel:02084129275">0208 412 9275</a>
                    @break

                    @default
                        <p style="font-size: 20px; font-weight: bold; color: rgb(10, 107, 7);">Your order is ready for
                            collection. Please
                            visit the branch to collect your order.</p>
                @endswitch
                </p>
            @else
