    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-text">
                ...
                <div class="sub-title"
                    style="padding: 10px; margin: 15px 0; background-color: #069406; color: #ffffff;">
                    <p style="font-weight: 600; color: rgb(255, 255, 255); text-transform: uppercase;">
                        <strong style="font-size: 24px;">We are preparing your order</strong>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="shipping-info">
            ...
            @if ($isPickup && $branch)
                ...
                <p><strong>Status: </strong>
                    @switch($branch->name)
                        @case('CATFORD')
                        <p>We are preparing your order for collection. We will notify you further.</p>
                    ...
                    @default
                        <p style="font-size: 20px; font-weight: bold; color: red;">We are preparing... <br> We will notify
                            you further.</p>
                @endswitch
                </p>
            @else
