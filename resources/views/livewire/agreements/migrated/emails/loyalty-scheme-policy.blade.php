...
<body>
    <div class="header" style="padding-top: 20px;">
        ...
        <h1 style="font-style: italic; font-weight: lighter;">Loyalty Upgrade Scheme Policy</h1>
    </div>
    <div class="container">
        <p>Dear {{ $customer->first_name ?? 'Valued Customer' }},</p>
        <p>{{ $body }}</p>
        <p>Your signed Loyalty Upgrade Scheme Policy document is attached to this email for your records.</p>
        <p>If you have any questions about the scheme, please email us at <a href="mailto:customerservice@neguinhomotors.co.uk">customerservice@neguinhomotors.co.uk</a>.</p>
