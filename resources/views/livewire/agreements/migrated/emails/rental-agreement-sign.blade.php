...
<head>
    ...
    <title>Your Hire Contract For Review</title>
    ...
    <div class="container" style="margin-top:20px;">
        ...
        <div class="content">
            ...
            <p style="line-height: 1.4; letter-spacing: 0.4px; padding: 10px 0 10px 0; margin: 0 0 7px 0; font-size: 15px;">
                ...
                please click the following link to review and sign the contract: <a href="{{ $mailData['url'] }}" target="_blank">{{ $mailData['url'] }}</a>
            ...
            <p style="margin-bottom:3px;">Hire Department</p>
        </div>
