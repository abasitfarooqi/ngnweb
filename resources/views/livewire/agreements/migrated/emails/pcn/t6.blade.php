...
<body>
    <div class="container">
        ...
        <p style="text-align: justify; padding: 4px; letter-spacing: 1.2px;">
            The following PCN(s) were appealed nearly 14 days ago, but the case(s) are still open. Please check the status with the relevant authority or portal, as there is a risk of escalation or increased charges if not resolved promptly.
        </p>
