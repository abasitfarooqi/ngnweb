...
<head>
    ...
    <title>{{ $booking->service_type }} - NGN Services</title>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="header-text">
                <p style="color: green; font-weight: bold;">Service Enquiry</p>
                <div class="sub-title">
                    <p>
                        <strong style="font-size: 26px;">Thank You for Submitting Your Enquiry!</strong>
                    </p>
                </div>
            </div>
        </div>
        <p>Dear {{ $booking->fullname }},</p>
        <p>Thank you for your submission regarding the {{ $booking->service_type }}. Below are the details you provided:</p>
        <ul>
            <li><strong>Service Type:</strong> {{ $booking->service_type }}</li>
            <li><strong>Full Name:</strong> {{ $booking->fullname }}</li>
            <li><strong>Phone:</strong> {{ $booking->phone }}</li>
            <li><strong>Registration Number:</strong> {{ $booking->reg_no }}</li>
            ...
            <li><strong>Message:</strong> {{ $booking->description }}</li>
            @endif
        </ul>
        <p>We will contact you shortly to confirm and schedule your service.</p>
        <div class="footer">
