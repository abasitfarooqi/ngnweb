...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="bg-gray-100 dark:bg-gray-800 h-72 flex items-center justify-center">
            <img src="{{ asset('img/ngn-motor-logo-fit-small-ngn.png') }}" alt="NGN Motors" class="h-24 w-auto opacity-50">
        </div>
    </div>
</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach([
                ...
                ['icon'=>'banknotes',        'title'=>'Payment plans',         'text'=>'Flexible payment plans to help you buy your dream bike. Competitive rates.', 'url'=>'/finance'],
