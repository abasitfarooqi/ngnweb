...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
    ...
    <div class="mt-10 bg-gray-50 dark:bg-gray-800 p-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-400">
            <div><span class="font-medium text-gray-900 dark:text-white">Mon – Fri</span><br>{{ config('site.opening_hours.monday') }}</div>
            <div><span class="font-medium text-gray-900 dark:text-white">Saturday</span><br>{{ config('site.opening_hours.saturday') }}</div>
            <div><span class="font-medium text-gray-900 dark:text-white">Sunday</span><br>{{ config('site.opening_hours.sunday') }}</div>
        </div>
    </div>
</div>
</div>
