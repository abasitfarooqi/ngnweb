    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center h-12 sm:h-16 gap-3">
            ...
            <a href="/" class="flex-shrink-0">
                <img src="{{ asset('img/ngn-motor-logo-fit-small-ngn.png') }}" alt="NGN Motors" class="h-9 sm:h-10 w-auto">
            </a>
            ...
            <nav class="hidden lg:flex items-center gap-0.5 ml-6 flex-1" x-data="{ open: null }" @mouseleave="open = null">
                ...
                <div class="relative" @mouseenter="open = 'sales'" @mouseleave="open = null">
                    ...
                    <div x-show="open === 'sales'" x-transition.opacity x-cloak
                        ...
                        <a href="{{ route('site.finance') }}" class="block px-4 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-gray-700 hover:text-brand-red">Payment plans</a>
        ...
        <div class="flex-1 overflow-y-auto overscroll-contain">
            ...
            <nav class="py-2">
                ...
                <div x-show="expandedGroup === 'sales'" x-transition class="bg-gray-50 dark:bg-gray-800">
                    ...
                    <a href="{{ route('site.finance') }}" @click="closeMobile()" class="block px-6 py-2.5 text-sm text-gray-700 dark:text-gray-300 hover:text-brand-red">Payment plans</a>
                ...
                <div class="border-t border-gray-100 dark:border-gray-800 mt-2 pt-2">
                    @auth('customer')
                        ...
                        <a href="{{ route('account.notifications') }}" @click="closeMobile()"
                           class="flex items-center gap-2 px-4 py-3 text-sm font-bold uppercase tracking-wide text-gray-900 dark:text-white hover:text-brand-red">
