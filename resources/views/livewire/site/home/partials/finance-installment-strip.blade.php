        ...
        <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            <div class="max-w-3xl">
                <a href="{{ route('site.finance') }}" class="group block">
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white tracking-tight group-hover:text-brand-red transition-colors">
                        Get Your Dream Motorbike <span class="text-brand-red">with Affordable Installments!</span>
                    </h2>
                </a>
            </div>
            <div class="flex flex-col sm:items-end gap-3 shrink-0">
                ...
                <flux:button href="tel:02083141498" variant="filled" class="bg-brand-red text-white hover:bg-brand-red-dark w-full sm:w-auto justify-center">
                    Call now
                </flux:button>
            </div>
        </div>
