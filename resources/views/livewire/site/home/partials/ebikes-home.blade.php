        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 items-center">
            <div class="md:col-span-4 text-center md:text-left">
                <flux:badge color="red" class="mb-3 uppercase tracking-widest text-[10px]">Electric</flux:badge>
                    <button type="button" class="block w-full max-w-sm mx-auto md:mx-0 border-0 p-0 bg-transparent cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-red focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900" @click="ebikeLightbox = true" aria-label="Enlarge eBike banner image">
            ...
            <div class="md:col-span-8 text-center md:text-left">
                <h2 class="text-2xl md:text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-3">eBikes revolution</h2>
                <p class="text-base md:text-lg font-semibold text-brand-red dark:text-red-400 mb-2">
                    Our first eBike launches in <strong>6 weeks</strong> — eco-friendly and smart.
                </p>
                <p class="text-sm text-gray-600 dark:text-gray-400 max-w-xl mx-auto md:mx-0 leading-relaxed mb-6">
                    Pedal-assist models for London riders. Register your interest and browse accessories on our eBikes page.
                </p>
    ...
    <template x-teleport="body">
        ...
        >
            <div class="relative max-w-5xl w-full max-h-[90vh] overflow-auto bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 shadow-xl">
                ...
                <div class="p-4 pt-12">
                    <img loading="lazy" src="{{ asset('assets/images/ebikes-rental-buy-london-banner.jpg') }}" alt="eBikes in London" class="w-full h-auto">
                </div>
            </div>
        </div>
    </template>
