<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Engine</h4>
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Transmission &amp; Drive</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Brakes</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Tires &amp; Wheels</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Electrical System</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Fluids and Levels</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Frame & Body</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Cooling System (if applicable)</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Exhaust System</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">General Inspection</h4>
    <ul class="feature-list">
...
<div class="svc-cat">
    <h4 class="text-brand-red font-bold mb-3">Additional Services (Optional)</h4>
    <ul class="feature-list">
        <li class="included">Test Ride: A test ride to ensure the bike performs correctly and to identify any issues that may not be apparent during a stationary check.</li>
