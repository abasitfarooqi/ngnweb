...
<div class="site-page-hero py-14">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <flux:button href="/motorbikes" variant="outline" class="border-white text-white hover:bg-white hover:text-gray-900">
            Browse Motorbikes For Sale
        </flux:button>
    </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
        @foreach([
            ['num'=>'1', 'title'=>'Choose Your Motorbike', 'text'=>'Browse our selection of new and used motorcycles and find the one that suits you.'],
            ['num'=>'2', 'title'=>'Apply for a Payment Plan', 'text'=>'Fill in our quick application form. Decision usually within 24 hours.'],
        ...
        <flux:card class="p-6 md:p-8 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm">
            ...
            @if($monthlyPayment)
                <div class="bg-gray-50 dark:bg-gray-800 p-6 text-center">
                    ...
                    <p class="text-xs text-gray-500 mt-2">Illustrative only. Final terms confirmed by our team. Not an offer of credit.</p>
                </div>
            @endif
        </flux:card>
    </div>
