...
<head>
    ...
    <title>Your Invoice For Review</title>
    ...
    <div class="container" style="margin-top:20px;">
        ...
        <div class="content">
            ...
            <p style="line-height: 1.4; letter-spacing: 0.4px; padding: 10px 0 10px 0; margin: 0 0 7px 0; font-size: 15px;">
                ...
                <br>
                We kindly request your attention to finalise your invoice with Neguinho Motors. To proceed, please click the following link to review and provide your account details:<a href="{{ $mailData['url'] }}" target="_blank">{{ $mailData['url'] }}</a>.
            </p>
            <br>
            <p style="margin-bottom:3px;">Thank you for choosing Neguinho Motors for your vehicle purchase.</p>
