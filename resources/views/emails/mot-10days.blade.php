...
<head>
    <meta charset="UTF-8">
    <title>MOT Expiry Reminder - 10 Days</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p>This is an urgent reminder that your MOT is due in soon for the vehicle registeration number:
            <strong>{{ $subscriber->reg_no }}</strong>.
        </p>
        <p>Please ensure that your MOT is renewed on time to avoid any issues.</p>
        <br>
