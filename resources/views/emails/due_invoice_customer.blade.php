...
<head>
    ...
    <title>Motorbike Rental Payment Reminder</title>
...
<body>
    <div class="container" style="margin-top:20px;">
        ...
        <div class="content">
            <h2 style="colour: #C31924;">Motorbike Rental Payment Reminder</h2>
            ...
            <p style="margin: 10px 0 0 0;">
                Your weekly rental payment of <b>£{{ $emailData['weekly_rent'] }}</b> for motorbike VIN <b>{{ $emailData['vin_number'] }}</b> and Reg No <b>{{ $emailData['registration_number'] }}</b> is due on <b>{{ \Carbon\Carbon::parse($emailData['invoice_date'])->format('Y-m-d') }}</b>   .
            </p>
            <p style="margin: 10px 0 0 0;">
            ...
            <p style="margin-bottom:3px;">Neguinho Motors Customer Service</p>
        </div>
