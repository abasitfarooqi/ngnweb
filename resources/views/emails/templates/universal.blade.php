<x-emails.base :subject="$subject ?? 'NGN Motors Update'">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="margin: 20px auto 26px;">
            <tr>
                <td style="background-color:#fff; text-align:center;">
                    <a href="{{ $actionUrl }}"
                        class="email-btn"
                        style="display:inline-block; padding:14px 30px; background-color:#fff; color:#ffffff; text-decoration:none; font-size:15px; font-weight:700; letter-spacing:0.02em;">
                        {{ $actionLabel }}
                    </a>
                </td>
            </tr>
    ...
    @if (!empty($actionUrl ?? null))
        ...
        <p style="margin:0 0 20px; font-size:12px; word-break:break-all;">
            <a href="{{ $actionUrl }}" style="color:#fff; text-decoration:none;">{{ $actionUrl }}</a>
        </p>
    @endif

    @foreach ($outro as $line)
        <p class="email-text" style="margin:0 0 10px; font-size:13px; color:#fff; line-height:1.7;">
            {{ $line }}
        </p>
    @endforeach
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin:0 0 6px;">
        <tr>
            <td style="padding:0 0 10px; font-size:12px; color:#fff; line-height:1.5;">
                <strong style="color:#c31924">Catford</strong><br>
        ...
        <tr>
            <td style="padding:0 0 10px; font-size:12px; color:#fff; line-height:1.5;">
                <strong style="color:#c31924">Tooting</strong><br>
        ...
        <tr>
            <td style="padding:0; font-size:12px; color:#fff; line-height:1.5;">
                <strong style="color:#c31924">Sutton</strong><br>
