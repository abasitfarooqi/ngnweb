  ...
  <div class="row" bp-section="crud-operation-list">
    ...
    <div class="{{ $crud->getListContentClass() }}">
        ...
        <div class="{{ backpack_theme_config('classes.tableWrapper') }}">
            <table
              id="crudTable"
              class="{{ backpack_theme_config('classes.table') ?? 'table table-striped table-hover rounded card-table table-vcenter card d-table shadow-xs border-xs' }}"
...
@endsection
@if(session('tol_pdf_file'))
    <script>
        window.addEventListener("load", function () {
            let fileUrl = "{{ asset('storage/tol_letters/' . session('tol_pdf_file')) }}";
            let link = document.createElement('a');
            link.href = fileUrl;
            link.download = "{{ session('tol_pdf_file') }}";
