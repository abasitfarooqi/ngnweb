...
<link rel="stylesheet" type="text/css" href="/assets/css/transparent-nav-hover.css">
<style>
...
<header id="header" class="header clearfix homepagex">
                        ...
                        @auth('customer')
                            ...
                            <div class="dropdown me-2">
                                <button class="btn-sm btn-light dropdown-toggle"
                                    style="padding: 0px 5px !important;margin-top: -4px;background: white;" type="button"
    ...
    <div class="container clearfix homepagex" id="site-header-inner">
        <div id="logo" class="logo float-left image-responsive col-lg-2  col-md-4 col-sm-4 col-xs-4">
            ...
            <!-- optimized -->
            <a href="/" title="logo" class="logo">
                <img src="{{ url('img/ngn-motor-logo-fit-optimized.png') }}" alt="NGN" width="55%" height="24"
                    data-retina="{{ url('img/ngn-motor-logo-fit-optimized.png') }}" data-width="55%" data-height="24">
            </a>
        </div><!-- /.logo -->
        ...
        <ul class="menu-extra">
            ...
            <li class="navbar-auth d-flex d-none">
                @auth('customer')
                    <div class="">
                        <button class="" style="padding: 0px 5px !important; margin-top: -4px;background: transparent;"
                        ...
                        <ul class="dropdown-menu dropdown-myaccount" aria-labelledby="accountDropdown">
                            <li><a class="dropdown-item dropdown-myaccount-item" href="{{ url('accountinformation/') }}"><i
                                        class="fa fa-info-circle mx-1 icons-width"></i> Account Information</a></li>
                            <li><a class="dropdown-item dropdown-myaccount-item"
                                    href="{{ url('accountinformation/profile') }}"><i
                                        class="fa fa-user mx-1 icons-width"></i> Profile</a></li>
                            <li><a class="dropdown-item dropdown-myaccount-item"
                                    href="{{ url('accountinformation/orders') }}"><i
                                        class="fa fa-list mx-1 icons-width"></i> Orders</a></li>
                            <li><a class="dropdown-item dropdown-myaccount-item"
                                    href="{{ url('accountinformation/addresses') }}"><i
                                        class="fa fa-home mx-1 icons-width"></i> Addresses</a></li>
                            <li><a class="dropdown-item dropdown-myaccount-item"
                                    href="{{ url('accountinformation/payment-methods') }}"><i
                                        class="fa fa-credit-card mx-1 icons-width"></i> Payment Methods</a></li>
                            <li><a class="dropdown-item dropdown-myaccount-item"
                                    href="{{ url('accountinformation/change-password') }}"><i
                                        class="fa fa-lock mx-1 icons-width"></i> Change Password</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item dropdown-myaccount-item" href=""
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
            ...
            <li>
                ...
                <a href="{{ route('product.cart') }}" class="effect-on-btn btn-shape ngn-bg view-cart-btn-x"> <i
                        class="fa fa-shopping-bag mx-1"></i> View
                    Cart</a>
            </li>
            ...
            <nav id="mainnav" class="mainnav">
                <ul class="menu">
                    <li>
                        ...
                        <a href="{{ route('services') }}#mot-booking-section">Book MOT</a>
                    </li>
                    <li>
                    ...
                    <!-- <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="{{ route('site.repairs.basic') }}">MOTORBIKE SERVICES</a>
                                <ul class="submenu">
                                    <li>
