...
@include('olders.frontend..ngnstore.components.hero-slider-component')
    ...
    <div class="home-content">
        ...
        <div class="container">
            @include('olders.frontend..ngnstore.components.item-swiper')
        </div>


        @include('olders.frontend..ngnstore.components.testimonials')



        <div class="container">
            @include('olders.frontend..ngnstore.components.product-tabs')
        </div>
