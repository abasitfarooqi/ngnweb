...
@section('title', 'About NGN - Motorcycle Rentals, Repairs, Sale in UK')

@section('meta_keywords')
    <meta name="keywords" content="NGN Club, motorcycle rentals, motorcycle repairs, motorcycle MOT,used motorcycle, motorcycle for sale, loyalty program, motorbike rewards">
@endsection

@section('meta_description')
    <meta name="description" content="Discover NGN is your premier destination in the UK for new and used motorcycle sales, rentals, repairs, and accessories. Located in Catford, Sutton and Tooting, we offer a wide range of services to meet all your motorcycling needs.">
@endsection
                ...
                <div class="flat-tabs style-1 has-border">
                    <div class="flat-grid-box col2 border-width border-width-1 has-padding clearfix">
                        <div class="grid-row image-left clearfix">
                            <div class="grid-item">
                                <div class="thumb text-center" data-aos="fade-in" data-aos-delay="100">
                                    <img loading="lazy" src="{{ url('assets/images/services/repairs.jpg') }}" alt="Image">
                                </div>
                            </div><!-- /.grid-item -->
                            <div class="grid-item">
                                <!-- <div class="text-wrap"> -->
                                <h2 class="title m-0 m-0 mb-3" data-aos="fade-up" data-aos-delay="100">Incorporated October 2018</h2>
                                <div class="entry-post mb-3" data-aos="fade-left" data-aos-delay="100">
                                    <p>
                                        NGN are proud to be Honda and Yamaha motorcycle specialists. We specialise in scooters and motorcycle sales, parts, servicing, repairs, as-well-as all the motorcycle accessories available in our online and off-line stores.
                                    </p>
                                    <p>
                        ...
                        <div class="grid-row image-right padding-bottom-48 clearfix">
                            <div class="grid-item">
                                <!-- <div class="text-wrap"> -->
                                <h2 class="title m-0 mb-3" data-aos="fade-up" data-aos-delay="100">Motorcycle Servicing, Repairs & Genuine Parts in London</h2>
                                <div class="entry-post mb-3" data-aos="fade-right" data-aos-delay="100">
                                    <p class="mb-3">
                        ...
                        <div class="grid-row image-left padding-bottom-48 clearfix">
                            ...
                            <div class="grid-item">
                                <!-- <div class="text-wrap"> -->
                                <h2 class="title m-0 mb-3" data-aos="fade-up" data-aos-delay="100">Motorcycle Hire & Rentals</h2>
                                <div class="entry-post mb-3" data-aos="fade-left" data-aos-delay="100">
                                    <p>
                                        NGN offers Yamaha and Honda motorcycle hire and rental.

                                        Whether you require a motorbike hire for a day, weekend, a European tour or the Isle of Man TT, NGN will ensure you are riding a well-maintained and fully insured hire motorbike.

                                        For those wanting an efficient and convenient service, NGN can deliver rental motorcycles to your chosen destination.
                                    </p>
                                </div>
                                <!-- </div> -->
                            </div>
                        ...
                        <div class="grid-row image-right clearfix">
                            <div class="grid-item">
                                <!-- <div class="text-wrap"> -->
                                <h2 class="title m-0 mb-3" data-aos="fade-up" data-aos-delay="100">Motorcycle Safety, Clothing & Accessories Shop</h2>
                                <div class="entry-post mb-3" data-aos="fade-right" data-aos-delay="100">
                                    <p>
