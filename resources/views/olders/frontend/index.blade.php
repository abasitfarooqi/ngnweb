...
@section('content')
    ...
    @include('olders.frontend.RecoveryMotorbikeANDNgnClubHomePageSection')


    @include('olders.frontend.eBikeHomePageSection')


    {{-- @include('olders.frontend.GridBoxHomePage') --}}
    @include('olders.frontend.ContactInformationSection')

    @include('olders.frontend.motorbikeRentalHomeSection')

    @include('olders.frontend.RepairsEnquirySection')



    {{-- <div class="ngnsection" style="padding-top: 0px;">
        @include('olders.frontend.NewBikesForSaleHomePageSection')
    </div> --}}

    <div class="ngnsection" style="padding-top: 0px;">
        @include('olders.frontend.UsedBikesForSaleHomePageSection')
    </div>


    {{-- @include('olders.frontend.MOTHomeSection') --}}

    @include('olders.frontend.InstalmentMotorbikes')

    <div class="ngnsection" style="padding-top: 0px;">
        @include('olders.frontend.RepairsHomepageComponent')
    </div>
    @include('olders.frontend.GetMotorbikeServicesEnquirySection')
    @include('olders.frontend.aboutHomeSection')

    {{-- @include('olders.frontend.motorservicesHomeSection') --}}


    {{-- @include('olders.frontend.advantagesHomeSection') --}}
    ...
    @include('olders.frontend.locationsHomeSection')
    <style>
        .mail-chimp {
            background: #f5f5f5;
