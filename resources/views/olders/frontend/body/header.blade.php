    ...
    <div class="container-fluid container-width-93 clearfix" id="site-header-inner">
        <div id="logo" class="logo float-left image-responsive col-lg-2  col-md-4 col-sm-4 col-xs-4">
            <!-- <a href="/" title="logo" class="logo">
                <img loading="lazy" src="{{ url('img/ngn-motor-logo-fit.png') }}" alt="NGN - Motorbike Rental and Repairs London" width="55%"
                    height="24" data-retina="{{ url('img/ngn-motor-logo-fit.png') }}" data-width="65%"
                    data-height="24">
            </a> -->
            <!-- optimized -->
            <a href="/" title="logo" class="logo">
                <img loading="lazy" src="{{ url('img/ngn-motor-logo-fit-optimized.png') }}" alt="NGN - Motorbike Rental and Repairs London" width="55%"
                    height="24" data-retina="{{ url('img/ngn-motor-logo-fit-optimized.png') }}" data-width="65%"
                    data-height="24">
            </a>
        </div><!-- /.logo -->
            ...
            <nav id="mainnav" class="mainnav">
                <ul class="menu">
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="/new-motorcycles">Motorcycles</a>
                            </li>
                            <li>
                    ...
                    <li class="rounded-lg border-gray-500" style="border:0.5px">
                        {{-- <a href="{{ route('ngnclub.subscribe') }}" class="text-gray-500">
                        <i class="fa fa-star badge badge-primary" style="background: #1e1e1e;color: white;color:white;"> Join NGN Club 10% OFF</i>
                        JOIN NGN CLUB
                    </a> --}}
                    ...
                    {{-- <li>
                    <a href="/finance"><img loading="lazy" src="{{ url('img/financebtn.png') }}" style="width:140px;"
                            class="finance-btn"></a>
                </li> --}}
