...
<head>
    ...
    <style>
        ...
        .bottom-border{
            ...
            border-bottom: 0.4px black solid !important;
            border-color: black;
            border-style: dotted;
        ...
        <div class="table-responsive d-none d-md-block">
            <table class="table-con">
                ...
                <tr>
                    ...
                    <td class="td-cont">EXPIRY DATE:
                    <td class="td-cont">VEHICLE PRICE</td>
                    <td class="td-cont">PAID</td>
                    @php
                        $is_monthly = $booking->is_monthly;
                        if ($is_monthly) {
                            echo '<td class="td-cont">MONTHLY ' . $booking->monthly_instalment . '</td>';
                        } else {
        ...
        <div class="modal fade" id="signatureModal" tabindex="-1" aria-labelledby="signatureModalLabel"
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content text-center">
                    <form action="/signed/bookings/create-new-contract-18m-extended" method="POST">
                        @csrf
                        <div class="text-center">
