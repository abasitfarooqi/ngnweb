        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="col mt-5">
                        <form action="/vehicle-check" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row align-items-start">
                                    <div class="col">
                                        ...
                                        <div class="d-grid gap-2 col-12 mx-auto">
                                            <button class="btn btn-outline-primary btn-block mt-4" type="submit"
                                                name="submit">CHECK MOTORCYCLE</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
