                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td class="text-capitalize"><a
                                                    href="{{ URL::to('users/' . $user->id) }}">{{ $user->first_name }}
                                                    {{ $user->last_name }}
                                                </a></th>
                                            <td><a
                                                    href="{{ URL::to('users/' . $user->id) }}">{{ $user->phone_number }}</a>
                                            </td>
                                            <td class="text-lowercase"><a
                                                    href="{{ URL::to('users/' . $user->id) }}">{{ $user->email }}</a>
                                            </td>
                                            {{-- <td></td> --}}
                                            {{-- <td>
                                                <a class="btn btn-outline-success"
                                                    href="{{ URL::to('users/' . $user->id) }}">Details</a>
                                            </td> --}}
                                        </tr>
                                    @endforeach
                                </tbody>
