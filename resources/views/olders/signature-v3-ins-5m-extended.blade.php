...
<body>
    ...
    <div class="container">
        ...
        <div style="padding: 0px !important; margin:0px !important; text-align: justify;">
            <div class="container"><b>Important Notice 1</b>
                <p>Used vehicles described in this contract must have its engine oil changed every week at
                    Neguinho
                    Motors Ltd
                    shop to
    ...
    <div class="modal fade" id="signatureModal" tabindex="-1" aria-labelledby="signatureModalLabel"
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content text-center">
                <form action="/signed/bookings/create-new-agreement-ins-5m-extended" method="POST">
                    @csrf
                    <div class="text-center">
    ...
    {{--
    <form action="/signed/bookings/create-new-agreement-ins" method="POST">
        @csrf
        <div class="text-center">
