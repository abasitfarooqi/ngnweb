...
<body>
    ...
    <table class="table-con">
        ...
        <tr>
            ...
            <td class="td-cont">
                {{ \Carbon\Carbon::parse($booking->contract_date)->addMonths(18)->format('d-F-Y H:i') }}
            </td>
    ...
    <div class="container">
        ...
        <div class="container" style="padding:0px !important; margin:0px !important;">
            ...
            @php
                ...
                $contractExpiry = Carbon::parse($booking->contract_date)->addMonths(18);
            ...
            <p style="padding-top:8px !important">
                ...
                formation. This contract is valid for 18 months from the contract date under the 'contract information'
        ...
        <ul style="margin-top:0px !important;padding-top:0px !important; padding-left:10px !important">
            ...
            <li style="padding-top:4px !important;">The user <b>NEGUINHO MOTORS
            LTD</b> or <b>HI-BIKE4U LTD</b> is the legal owner of
                the vehicle.</li>
        ...
        <div class="agreement-section">
            ...
            <div class="agreement-section">
                ...
                <h4>Signature Date: {{ \Carbon\Carbon::parse($booking->contract_date)->format('d-F-Y') }}</h4>
                <h3>Signature</h3>
