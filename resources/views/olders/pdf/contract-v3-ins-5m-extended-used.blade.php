{{-- Finance Contract | 12 MAR 2025 V3 Update Rev.3 --}}
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="watermark" style="letter-spacing: 1.7px">{{ $motorbike->reg_no }}
        {{ $customer->first_name }}
        {{ $customer->last_name }} | V3 Rev#1</div>


    <div class="header" style="padding:1px;margin:1px">
        <span style="font-size:7px">V3 Rev#1 - {{ $document_number }}</span>
    ...
    <table class="table-con">
        ...
        <tr>
            ...
            <td class="td-cont">
                {{ \Carbon\Carbon::parse($booking->contract_date)->addMonths(5)->format('d-F-Y') }}
            </td> -->
    ...
    <div class="container">
        ...
        <div class="container" style="padding:0px !important; margin:0px !important;">
            ...
            @php
                ...
                // Parse the creation date of the booking and add five months to set the fixed expiry of the hire agreement
                $contractExpiry = Carbon::parse($contractStartDate)->addMonths(5);
            ...
            <p style="padding-top:8px !important">
            Customers are liable to pay 50% of total cost
upfront for any electrical repairs. <br>

Customers are
liable to pay 50% of total cost upfront for
any engine repairs. <br>

The limited warranty is only
valid whilst the total amount of the vehicle is
outstanding, this warranty will automatically
expire once the vehicle has been fully paid and no
outstanding amount is held against the vehicle.
            </p>
            <p style="padding-bottom:4px !important">Used vehicles described in this contract must have
its engine oil changed every week at Neguinho
Motors Ltd shop to claim the engine
warranty repairs. All receipts must be kept as proof.
Failing to provide one or all receipts will
automatically void the engine warranty
repairs.</p>
                <!-- <b>Conditional Warranty</b>
            <ul style="margin-top:0px !important;padding-top:0px !important; padding-left:10px !important">
                <li style="padding-top:4px !important;">£500 deposit (non-refundable)</li>
                <li style="padding-top:4px !important;">NGN will cover 50% of the total cost of electrical and engine repairs.</li>
                <li style="padding-top:4px !important;">Repairs and modifications can only be carried out in NGN's authorised workshop.</li>
                <li style="padding-top:4px !important;">NGN Club: On eligible purchases, you earn 10% NGN credits.</li>
                
            </ul>
            <b>Conditions Applied on warranty:</b>
            <ul style="margin-top:0px !important;padding-top:0px !important; padding-left:10px !important">
                <li style="padding-top:4px !important;">All benefits apply only if rental payments are made on time</li>
                <li style="padding-top:4px !important;">Any late or missed payments may cancel this warranty and all related benefits.</li>
                <li style="padding-top:4px !important;">This warranty and all benefits are only valid for 18 months from the starting date of this agreement and it will terminate if this agreement is cancelled.</li>
                <li style="padding-top:4px !important;">No claims will be accepted or valid after this agreement expires or cancelled.</li>
            </ul>
            <p style="padding-bottom:4px !important">Used vehicles described in this contract must have its engine oil changed every week at Neguinho Motors Ltd shop to claim the engine warranty repairs. All receipts must be kept as proof; Failing to provide one or all receipts will automatically void the engine warranty repairs.</p> -->
            ...
            <p style="padding-top: 4px !important; margin: 4px !important; text-align: justify;">NEGUINHO MOTORS LTD or
                HI-BIKE4U LTD will inform the customer about
            ...
            <p style="padding-top:8px !important">
                ...
                formation. This contract is valid for 5 months from the contract date under the 'contract information'
                section of this contract shown at the first page of this document. </p>
            <p style="padding-top: 4px !important; margin: 4px !important; text-align: justify;">You confirm and
                acknowledge that you have had every opportunity to become acquainted with the terms and
            ...
            <p style="padding-top: 4px !important; margin: 4px !important; text-align: justify;">You acknowledge and
                confirm that any delay in the payment of such charges, or non-payment by you, will
            ...
            <p style="padding-top: 4px !important; margin: 4px !important; text-align: justify;">Failure to pay on time
                will incur late payment fees. A £10 fee is added each day after the first day
            ...
            <table class="table" style="padding-top:2px !important; width:50%">
                ...
                <tbody>
                    <tr>
                        <td style="width:30%;height:16px">Day 1</td>
                        <td style="width:30%;height:16px">£0</td>
                    </tr>
                    <tr>
                        <td style="width:30%;height:16px">Day 2</td>
                        <td style="width:30%;height:16px">£10</td>
                    </tr>
                    <tr>
                        <td style="width:30%;height:16px">Day 3</td>
                        <td style="width:30%;height:16px">£20</td>
                    </tr>
                    <tr>
                        <td style="width:30%;height:16px">Day 4</td>
                        <td style="width:30%;height:16px">£30</td>
                    </tr>
                    <tr>
                        <td style="width:30%;height:16px">Day 5</td>
                        <td style="width:30%;height:16px">£40</td>
                    </tr>
                    <tr>
                        <td style="width:30%;height:16px">Day 6</td>
                        <td style="width:30%;height:16px">£50</td>
                    </tr>
                    <tr>
                        <td style="width:30%;height:16px">Day 7</td>
                        <td style="width:30%;height:16px">£60</td>
                    </tr>
                </tbody>
            </table>
            <p style="padding-top: 4px !important; margin: 4px !important; text-align: justify;">The company has a
                zero-tolerance policy for overdue payments and will not accept any kind of excuse.</p>
            <br>
        ...
        <ul style="margin-top:0px !important;padding-top:0px !important; padding-left:10px !important">
            ...
            <li style="padding-top:4px !important;">The user <b>{{ $customer->first_name }}
                    {{ $customer->last_name }}</b> is the legal owner of
                the vehicle.</li>
        ...
        <div style="padding: 0px !important; margin:0px !important; text-align: justify;">
            <div class="container"><b>Important Notice 1</b>
                <p style="padding-top: 4px !important; margin: 4px !important; text-align: justify;">No modifications
                    should be made to the vehicle without
                    written agreement from <b>NEGUINHO MOTORS
                        LTD</b> or <b>HI-BIKE4U LTD</b>, as this may void any warranty.
                    NEW VEHICLES MUST HAVE THEIR FIRST
                    SERVICE AT
                    600
        ...
        <div class="agreement-section">
            ...
            <div class="agreement-section">
                ...
                <h4>Signature Date: {{ \Carbon\Carbon::parse($contractStartDate)->format('d-F-Y') }}</h4>
                <h3>Signature</h3>
                <p style="padding-top: 4px !important; margin: 4px !important; text-align: justify;">By signing below,
                    the keeper agrees to the terms and conditions of this Motorcycle Sale/Hire
                    Contract.
                </p>
                <img src="{{ storage_path('app/public/' . $SIGFILE) }}" style="width: 199.25px; height: 71.2px">
