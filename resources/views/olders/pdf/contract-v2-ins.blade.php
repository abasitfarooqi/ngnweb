...
<body>
    ...
    <div class="watermark" style="letter-spacing: 1.7px">{{ $motorbike->reg_no }}
        {{ $customer->first_name }}
        {{ $customer->last_name }} | V2 Rev#2</div>


    <div class="header" style="padding:1px;margin:1px">
        <span style="font-size:7px">V2 Rev#2</span>
    ...
    <div class="container">
        ...
        <div class="container" style="padding:0px !important; margin:0px !important;">
            ...
            <p>
                This contract is valid for 5 months from the 'contract date' under the 'contract information' section
