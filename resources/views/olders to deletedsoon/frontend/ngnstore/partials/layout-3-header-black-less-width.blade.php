<link rel="stylesheet" type="text/css" href="/assets/css/layout-3-header-black-forced-less-width.css">
<!-- Header -->
<header id="header" class="header clearfix homepagex forced-blacked">

    <!-- Start Top Nav -->
    <!-- <nav class="navbar navbar-expand navbar-dark bg-dark d-none d-lg-block forced-blacked  pt-1 pb-1"
...
<a style="color: white;" class="navbar-sm-brand text-light text-decoration-none"
                    ...
                    <a style="color: white;" class="navbar-sm-brand text-light text-decoration-none"
                        href="{{ route('contact.call-back') }}" onmouseover="this.style.color='#f63440'"
    ...
    <div class="container  clearfix homepagex forced-blacked" id="site-header-inner">
        <div id="logo" class="logo float-left image-responsive col-lg-2 col-md-4 col-sm-4 col-xs-4 pl-2">
        ...
        <div id="talkus" class="talkus-box col-lg-5 col-md-6 col-sm-6 d-none d-lg-block" style="">
            <i style="color: white;">Call our experts</i>
            ...
            <a style="color: white;" class="navbar-sm-brand text-light text-decoration-none"
                ...
                onMouseOut="this.style.color='#fff'">Request Callback</a>
            <i class="fa fa-briefcase mx-2" style="color:white;"></i>
            <a style="color: white;" class="navbar-sm-brand text-light text-decoration-none" href="{{ url('/career') }}"
                onmouseover="this.style.color='#f63440'" onMouseOut="this.style.color='#fff'">Career</a>
            <div class="talkus w-100 d-flex justify-content-between">
                <h3 style="color: #b41822;"><a style="color: #b41822;" href="tel:02083141498">0208 314 1498</a> | <a
                        style="color: #b41822;" href="tel:02034095478">0203 409 5478</a></h3>
            </div>
        </div>
                ...
                <!-- <li class="box-search d-lg-none">
                    ...
                    <form role="search" method="get" class="header-search-form"
                        ...
                        <input type="text" value="{{ request('query') }}" name="query"
                            class="header-search-field" placeholder="Search...">
                        <button type="submit" class="header-search-submit" title="Search">Search</button>
                    </form>
                </li>
