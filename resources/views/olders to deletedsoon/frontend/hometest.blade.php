...
@include('olders.frontend.ProductCarouselTabBased')
...
{{-- @include('olders.frontend.sparepartHomeSection') --}}
...
<section class="hero bg-dark text-white text-center py-5">
        <div class="container">
        <!-- {{ url('img/ngn-motor-logo-fit-small.png') }} -->
            <img loading="lazy" src="{{ asset('img/ngn-motor-logo-fit-small.png') }}" alt="NGN - Motorcycle Rentals, Repairs, and Motorcycle MOT in London, Catford, and Tooting" class="mb-3" style="width:300px;">
    ...
    @include('olders.frontend.contactHomeSection')

    @include('olders.frontend.testimonialsHomeSection')
