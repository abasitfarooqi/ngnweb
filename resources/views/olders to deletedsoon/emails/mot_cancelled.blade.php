...
<body>
    <div class="container">
        ...
        <h4>Refund Policy</h4>
        <p>Please note, as this cancellation is due to <strong>{{ $cancellation_reason }}</strong>, no refund will be issued in accordance with current MOT Booking guidelines. For more information on MOT fees and the refund policy, you may refer to the <a href="https://www.gov.uk/guidance/mot-testing-guide/appendix-3-grounds-for-refusal" class="link">MOT Booking Guide</a>.</p>
