                            ...
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        ...
                                        <h3>Your rental payment is due by
                                            {{ Carbon\Carbon::now()->addDay()->format('d/m/Y') }}</h3>

                                        <p>
                                            Please be prompt with your weekly payments as failure to pay on time will
                                            incur late payment fees.
                                            A £20 fee is added each day, after the first day until the outstanding
                                            balance on the account is paid.
                                        </p>
                                        <p>
