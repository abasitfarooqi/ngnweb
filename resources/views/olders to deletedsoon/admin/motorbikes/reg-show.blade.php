                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.motorbikes.vehicleCheck') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @if ($motorcycle->motStatus == 'Valid' || $motorcycle->motStatus == 'Not valid')
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end">{{ $motorcycle->motExpiryDate }}
                                                                    </td>
                                                                </tr>
                                                            @else
                                                                <tr>
                                                            ...
                                                            <tr>
                                                                <td>Year </td>
                                                                <td class="text-end">{{ $motorcycle->yearOfManufacture }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Engine </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    {{ $motorcycle->markedForExport ? 'TRUE' : 'FALSE' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Colour </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">{{ $motorcycle->dateOfLastV5CIssued }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Wheel Plan </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-end">
                                                                    {{ $motorcycle->monthOfFirstRegistration }}</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
