...
@include('frontend..ngnstore.components.hero-slider-component')
    ...
    <div class="home-content">
        ...
        <div class="container">
            @include('frontend..ngnstore.components.item-swiper')
        </div>


        @include('frontend..ngnstore.components.testimonials')



        <div class="container">
            @include('frontend..ngnstore.components.product-tabs')
        </div>
