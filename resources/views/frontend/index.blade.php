...
@section('content')
    ...
    @include('frontend.RecoveryMotorbikeANDNgnClubHomePageSection')


    @include('frontend.eBikeHomePageSection')


    {{-- @include('frontend.GridBoxHomePage') --}}
    @include('frontend.ContactInformationSection')

    @include('frontend.motorbikeRentalHomeSection')

    @include('frontend.RepairsEnquirySection')



    {{-- <div class="ngnsection" style="padding-top: 0px;">
        @include('frontend.NewBikesForSaleHomePageSection')
    </div> --}}

    <div class="ngnsection" style="padding-top: 0px;">
        @include('frontend.UsedBikesForSaleHomePageSection')
    </div>


    {{-- @include('frontend.MOTHomeSection') --}}

    @include('frontend.InstalmentMotorbikes')

    <div class="ngnsection" style="padding-top: 0px;">
        @include('frontend.RepairsHomepageComponent')
    </div>
    @include('frontend.GetMotorbikeServicesEnquirySection')
    @include('frontend.aboutHomeSection')

    {{-- @include('frontend.motorservicesHomeSection') --}}


    {{-- @include('frontend.advantagesHomeSection') --}}
    ...
    @include('frontend.locationsHomeSection')
    <style>
        .mail-chimp {
            background: #f5f5f5;
