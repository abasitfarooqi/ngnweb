                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="title-section">
                        <div class="d-flex justify-content-between align-items-center">
                            <h2 class="title aos-init aos-animate" data-aos="fade-right">Get A Quote<span
                                    class="instalment-gradient-text"> for Motorcycle Full Service!</span>
                            </h2>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div class="installment-call-now text-right" style="margin-top: -44px;">
                        ...
                        <a href="javascript:void(0);" class="effect-on-btn btn-shape font-two"
                            ...
                            onclick="setServiceTypeAndRedirect('Motorcycle Basic Service')">Enquiry on Motorcycle
                            Servicing</a>
                    </div>
                </div>
            </div>
