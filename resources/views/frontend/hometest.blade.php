...
@include('frontend.ProductCarouselTabBased')
...
{{-- @include('frontend.sparepartHomeSection') --}}
...
<section class="hero bg-dark text-white text-center py-5">
    ...
    @include('frontend.contactHomeSection')

    @include('frontend.testimonialsHomeSection')
