    ...
    <div class="container-fluid">
        <p class="bg-danger text-center"
            style="font-size: 12px ;padding: 4px;margin:4px ; font-weight: bold ; color: rgb(255, 255, 255);"><span
                ...
                LINK WILL
                EXPIRE BY: {{ $access->expires_at->format('d F Y') }}.</span>
            <br>
        ...
        <div class="d-md-none">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Whatsapp: <span
                            style="text-decoration: none !important; pointer-events: none; ">{{ $customer->whatsapp ?? 'No Whatsapp number provided' }}
                        </span> </li>   
                ...
                <tr class="no-border">
                    <td class="td-cont" colspan="2"
                        style="font-size:10px ; padding-bottom: 15px; padding-top:10px; margin-top:10px"><b>
                            ALL DOCUMENTS AND PAYMENTS MUST BE DONE WITHIN 48 HOURS OF BOOKING, FAILING TO DO SO WILL
            ...
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">CONTRACT DATE:
                        {{ \Carbon\Carbon::parse($booking->contract_date)->format('d-F-Y H:i') }}</li>
                        <li class="list-group-item">EXPIRY DATE:
                        {{ \Carbon\Carbon::parse($booking->contract_date)->addMonths(5)->format('d-F-Y H:i') }}</li>
                    ...
                    @php
                        ...
                        if ($is_monthly) {
                            echo '<li class="list-group-item">MONTHLY: ' .
                                $booking->weekly_instalment .
                                ' (10th of Each Month)</li>';
                        } else {
                            echo '<li class="list-group-item">WEEKLY: ' . $booking->weekly_instalment . '</li>';
                        }
                ...
                <div class="d-md-none">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">ISSUANCE COUNTRY: {{ $customer->license_issuance_authority }}
                            </li>
                        </ul>
                    </div>
                </div>
                <ul class="table-con" style="padding:10px;font-size:14;">
                    <li>
        ...
        <div class="table-responsive d-none d-md-block">
            <table class="table-con">
                ...
                <tr>
                    ...
                    <td class="td-cont">{{ \Carbon\Carbon::parse($booking->contract_date)->format('d-F-Y H:i') }}

                    </td>
                    <td class="td-cont">
                        {{ \Carbon\Carbon::parse($booking->contract_date)->addMonths(5)->format('d-F-Y H:i') }}
                    </td>
            ...
            <div class="table-responsive d-none d-md-block">
                <table class="table-con">
                    <tr>
                        <th colspan="3" style="text-align:center;">LICENCE INFORMATION</th>
                    </tr>
                    <tr>
            ...
            <tr>
                <td colspan="2" class="td-cont">
                    <span style="padding:2px !important;margin:2px !important; padding-top: 2px !important"> I
                        ...
                        Conditions under this Hire/Sale Agreement without any exception or reservation. </span>
                    <br>
                </td>
            </tr>
            <tr>
    ...
    <div class="container">
        ...
        <div class="container">
            ...
            @php
                ...
                $contractExpiry = Carbon::parse($booking->created_at)->addMonths(5);
...
repairs.</p>
            ...
            <ul style="padding-left:2px">
                <li>• £500 deposit (non-refundable)</li>
                <li>• NGN will cover 50% of the total cost of electrical and engine repairs.</li>
                <li>• Repairs and modifications can only be carried out in NGN's authorised workshop.</li>
                <li>• NGN Club: On eligible purchases, you earn 10% NGN credits.</li>
            </ul>   
            <b>Conditions Applied on warranty:</b>
            <ul style="padding-left:2px">
            <li>• Any late or missed payments may cancel this warranty and all related benefits.</li>
                <li>• This warranty and all benefits are only valid for 18 months from the starting date of this agreement and it will terminate if this agreement is cancelled.</li>
                <li>• No claims will be accepted or valid after this agreement expires or cancelled.</li>
        ...
        <ul style="padding-left:9px;margin-left:9px">
            ...
            <li>•&emsp;The user <b>{{ $customer->first_name }} {{ $customer->last_name }}</b> is the legal owner
                of
                the vehicle <b>{{ $motorbike->reg_no }}</b>.</li>
        ...
        <div style="padding: 0px !important; margin:0px !important; text-align: justify;">
            <div class="container"><b>Important Notice 1</b>
                <p>No modifications should be made to the vehicle without written agreement from <b>NEGUINHO MOTORS
    ...
    <div class="container">
        ...
        <div class="modal fade" id="signatureModal" tabindex="-1" aria-labelledby="signatureModalLabel"
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content text-center">
                    <form action="/signed/bookings/create-new-contract-ins-5m-extended" method="POST">
                        @csrf
                        <div class="text-center">
                            ...
                            <div id="signature-pad-booking-id">
                                <input type="hidden" name="booking_id" value="{{ $booking->id }}">
                                    ...
                                    <!-- <input type="hidden" name="contact_date" value="{{ \Carbon\Carbon::parse($booking->contact_date)->format('d-F-Y H:i') }}"> -->
                            </div>
        ...
        {{-- <form action="/signed/bookings/create-new-contract-ins" method="POST">
            @csrf
            <div class="text-center">
                <i class="dripicons-checkmark h1 text-white"></i>
                <h4 class="mt-2 text-black">Sign Here!</h4>
