...
<head>
    ...
    <style type="text/css">
        ...
        .email-outer{background-color:#f3f4f6!important}
        .email-card{background-color:#ffffff!important;border-color:#e5e7eb!important}
        .email-text{color:#111827!important}
        .email-muted{color:#4b5563!important}
        .email-divider{border-color:#e5e7eb!important}
        .email-legacy-html,.email-legacy-html td,.email-legacy-html th,.email-legacy-html p,.email-legacy-html li,.email-legacy-html span,.email-legacy-html div,.email-legacy-html h1,.email-legacy-html h2,.email-legacy-html h3,.email-legacy-html h4{color:#111827!important}
...
<body class="email-body" style="margin:0;padding:0;background-color:#f3f4f6!important;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
<table class="email-outer" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#f3f4f6!important;">
    <tr>
        <td align="center" style="padding:28px 14px;">
            <table class="email-wrapper" width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width:600px;">
                ...
                <tr>
                    <td>
                        <table class="email-card" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#ffffff!important;border:1px solid #e5e7eb!important;border-top:4px solid #c31924!important;">
                            <tr>
                ...
                <tr>
                    <td align="center" style="padding:26px 12px 14px;">
                        <p class="email-muted" style="margin:0 0 8px;font-size:12px;color:#4b5563!important;text-align:center;">NGN Motors &bull; Catford &bull; Tooting &bull; Sutton</p>
                        <p class="email-muted" style="margin:0 0 8px;font-size:12px;color:#4b5563!important;text-align:center;">
                            <a href="https://ngnmotors.co.uk/legals/privacy-policy" style="color:#c31924!important;text-decoration:underline;">Privacy Policy</a>
                            &nbsp;&bull;&nbsp;
                            <a href="https://ngnmotors.co.uk/legals/terms-conditions" style="color:#c31924!important;text-decoration:underline;">Terms</a>
                            &nbsp;&bull;&nbsp;
                            <a href="https://ngnmotors.co.uk" style="color:#c31924!important;text-decoration:underline;">Website</a>
                        </p>
