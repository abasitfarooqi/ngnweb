    ...
    <tr>
        <td align="center" style="padding:32px 16px;">
            <table class="email-wrapper" width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width:600px;">
                ...
                <tr>
                    <td>
                        <table class="email-card" width="100%" border="0" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border:1px solid #e5e7eb;border-top:3px solid #c31924;">
                            <tr>
                ...
                <tr>
                    <td align="center" style="padding:28px 0 16px;">
                        <p class="email-muted" style="margin:0 0 8px;font-size:12px;color:#6b7280;text-align:center;">NGN Motors &bull; Catford &bull; Tooting &bull; Sutton</p>
                        ...
                        <p class="email-muted" style="margin:0;font-size:11px;color:#9ca3af;text-align:center;">&copy; {{ date('Y') }} NGN Motors Ltd. All rights reserved.</p>
                    </td>
                </tr>
            </table>
        </td>
