            ...
            @auth
                <div class="row align-items-start">
                    <div class="col col-lg-8">
                        <div class="btn-group">
                            <div class="btn">
                                <a class="btn btn-outline-primary" href="{{ URL::to('/motorcycles-new-rental') }}">Add
                                    Motorcycle</a>
                    ...
                    <div class="container">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <div class="btn">
                                ...
                                <a class="btn btn-primary mt-4" href="{{ URL::to('claim-in-progress/') }}">Claim In
                                    Progress</a>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($motorcycles as $motorcycle)
                                        <tr>
                                            <th class="text-uppercase" scope="row"><a
                                                    href="{{ URL::to('motorcycle-show/' . $motorcycle->id) }}">{{ $motorcycle->registration }}</a>
                                            </th>
                                            <td class="text-uppercase"><a
                                                    href="{{ URL::to('motorcycle-show/' . $motorcycle->id) }}">{{ $motorcycle->make }}</a>
                                            </td>
                                            <td class="text-uppercase"><a
                                                    href="{{ URL::to('motorcycle-show/' . $motorcycle->id) }}">{{ $motorcycle->model }}</a>
                                            </td>
                                            <td class="text-uppercase"><a
                                                    href="{{ URL::to('motorcycle-show/' . $motorcycle->id) }}">{{ $motorcycle->engine }}CC</a>
                                            </td>
                                            <td class="text-uppercase"><a
                                                    href="{{ URL::to('motorcycle-show/' . $motorcycle->id) }}">{{ $motorcycle->year }}</a>
                                            </td>
                                            <td class="text-uppercase"><a
                                                    href="{{ URL::to('motorcycle-show/' . $motorcycle->id) }}">{{ $motorcycle->colour }}</a>
                                            </td>
                                            <td>
                                                @if ($motorcycle->availability === 'for rent')
                                                    <a class="btn btn-outline-primary"
                                                        href="{{ URL::to('rental-signup/' . $motorcycle->id) }}"
