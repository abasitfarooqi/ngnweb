...
@section('title', 'Rental Agreement Link')
...
<script>
    // CSRF token refresh for customer rental signup form
    document.addEventListener('DOMContentLoaded', function() {
        var formToken = document.querySelector('input[name="_token"]');
        var metaToken = document.querySelector('meta[name="csrf-token"]');
        var form = document.querySelector('form[action="{{ url("/customerrentalsignup") }}"]');
