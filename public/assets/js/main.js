...
; (function ($) {
    ...
    var responsiveMenu = function () {
        ...
        $('.mobile-button').on('click', function () {
            ...
            // Toggle class on .hero-page based on the .active class on .mobile-button
            $('.hero-page').toggleClass('hero-margin-adjust');

            // Toggle class on the header to change its background to black when active
            if ($(this).hasClass('active')) {
                $('#header').removeClass('homepagex').addClass('header-bg-black-toggle');
            } else {
                $('#header').addClass('homepagex').removeClass('header-bg-black-toggle');
            }
        ...
        $(window).on("load resize", function () {
            setTimeout(function () {
                try {
                    ...
                    console.error('Error in flatEqualHeight:', error);
                }
            }, 500);
        });
    };
