                    ...
                    <div class="col-md-12">
                        ...
                        <div class="breadcrumbs">
                            <ul>
                                ...
                                <li><a href="/new-motorcycle/{{ $motorcycle->slug }}">{{ $motorcycle->make }}
                                        {{ $motorcycle->model }}</a></li>
                            </ul>
                        </div><!-- /.breadcrumbs -->
                    </div><!-- /.col-md-12 -->
                </div><!-- /.row -->
                        ...
                        <div class="flat-image-box clearfix">
                            <div class="inner padding-top-4">
                                <ul class="product-list-fix-image">
                                    <li>
                                        <img src="{{ url('/storage/uploads/' . $motorcycle->file_name) }}"
                                            alt="Image">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="product-detail">
                            <div class="inner">
                                <div class="content-detail form-group">
                                    <h2 class="product-title" value="{{ $motorcycle->description }}" name="name">
                                        {{ $motorcycle->make }} {{ $motorcycle->model }}</h2>
                                    ...
                                    <div class="price margin-top-24">
                                        <ins><span class="amount" value="{{ $motorcycle->price }}" name="price"
                                                id="price">£{{ $motorcycle->rental_price }} per Week</span></ins>
                                    </div>
                                ...
                                <div class="product-tags">
                                    <span>Tags: </span><a href="#"></a> <a href="#"></a> <a
                                        href="#"></a> <a href="#"></a>
                                </div>
                                            ...
                                            <div class="grid-item">
                                                <div class="text-wrap">
                                                    ...
                                                    <p class="mb-3">
                                                        ...
                                                        motorcycle. If you don't have one you can always purchase from
                                                        our shop along with lot's of other motorcycle accessories.
                                                    </p>
                                                    <p class="mb-3">
