...
return [
    ...
    */
    ...
    'mailers' => [
        ...
        'bulk' => [
            ...
            'port' => env('MAIL_BULK_PORT', 587),
            'encryption' => env('MAIL_BULK_ENCRYPTION', 'tls'),
            'username' => env('MAIL_BULK_USERNAME'),
            'password' => env('MAIL_BULK_PASSWORD'),
            'timeout' => null,
            'local_domain' => env('MAIL_EHLO_DOMAIN'),
        ],
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'customerservice@neguinhomotors.co.uk'),
