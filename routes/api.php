...
Route::prefix('v1/mobile')->group(function () {
    ...
    Route::middleware('auth:sanctum')->prefix('club/legacy')->group(function () {
        Route::post('member-purchases', [MobileClubLegacyController::class, 'storePurchase']);
        Route::post('member-purchases-mb', [MobileClubLegacyController::class, 'storePurchaseMb']);
        Route::post('customer-spending', [MobileClubLegacyController::class, 'storeSpending']);
        Route::post('list-customer-spending', [MobileClubLegacyController::class, 'listSpending']);
        Route::post('delete-customer-spending', [MobileClubLegacyController::class, 'deleteSpending']);
        Route::post('record-spending-payment', [MobileClubLegacyController::class, 'recordSpendingPayment']);
        Route::post('spending-payment-history', [MobileClubLegacyController::class, 'spendingPaymentHistory']);
        Route::post('credit-status', [MobileClubLegacyController::class, 'creditStatus']);
        Route::post('credit-status-get-time', [MobileClubLegacyController::class, 'creditStatusWithTime']);
        Route::post('initiate-redeem', [MobileClubLegacyController::class, 'initiateRedeem']);
        Route::post('verify-otp-and-redeem', [MobileClubLegacyController::class, 'verifyOtpAndRedeem']);
        Route::post('update-redeem-invoice', [MobileClubLegacyController::class, 'updateRedeemInvoice']);
        Route::post('referral-status', [MobileClubLegacyController::class, 'referralStatus']);
    });
    ...
    Route::middleware('auth:customer,sanctum')->group(function () {
        ...
        Route::post('portal/orders/{id}/cancel', [MobilePortalAccountController::class, 'cancelOrder']);
        ...
        Route::get('portal/recovery-requests/{id}', [MobilePortalController::class, 'recoveryRequestDetail']);
        Route::get('portal/finance/applications', [MobilePortalController::class, 'financeApplications']);
        Route::get('portal/finance/applications/{id}', [MobilePortalController::class, 'financeApplicationDetail']);
        ...
        Route::post('portal/security/resend-verification', [MobilePortalAccountController::class, 'resendVerification']);
